...
public class gnu_targets_rts86U
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('gnu.targets.rts86U$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['gnu.targets.rts86U$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['gnu.targets.rts86U$$stat$root'];\n");
        sb.append("}\n");
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/gnu.targets.rts86U.a86_64U',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/gnu.targets.rts86U.a86_64U', {target: 'gnu.targets.Linux86_64', suffix: '86_64U'}],\n");
        sb.append("];\n");
