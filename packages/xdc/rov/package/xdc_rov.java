...
public class xdc_rov
{
    ...
    void Program$$FUNCTIONS()
    {
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$fetchStaticString", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Str, 1, 1, false));
                fxn.addArg(0, "addr", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF);
        // fxn Program.fetchFromAddr
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$fetchFromAddr", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Obj, 3, 2, false));
                fxn.addArg(0, "addr", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF);
                fxn.addArg(1, "typename", $$T_Str, $$UNDEF);
                fxn.addArg(2, "count", Proto.Elm.newCNum("(xdc_Int)"), 1L);
        // fxn Program.fetchVariable
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$fetchVariable", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Obj, 1, 1, false));
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$lookupFuncName", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Obj, 1, 1, false));
                fxn.addArg(0, "addr", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF);
        // fxn Program.lookupType
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$lookupType", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Obj, 1, 1, false));
                fxn.addArg(0, "type", $$T_Str, $$UNDEF);
        // fxn Program.lookupTypeByVariable
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$lookupTypeByVariable", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), $$T_Obj, 1, 1, false));
                fxn.addArg(0, "varName", $$T_Str, $$UNDEF);
        // fxn Program.lookupSymbolValue
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$lookupSymbolValue", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), Proto.Elm.newCNum("(xdc_Int)"), 1, 1, false));
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$getSupportedTabs", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), new Proto.Arr((Proto)om.findStrict("xdc.rov.Program.Tab", "xdc.rov"), false), 1, 1, false));
                fxn.addArg(0, "modName", $$T_Str, $$UNDEF);
        // fxn Program.addCMod
        fxn = (Proto.Fxn)om.bind("xdc.rov.Program$$addCMod", new Proto.Fxn(om.findStrict("xdc.rov.Program.Module", "xdc.rov"), null, 1, 1, false));
                fxn.addArg(0, "mod", $$T_Obj, $$UNDEF);
    ...
    void Program$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                po.addFxn("lookupType", (Proto.Fxn)om.findStrict("xdc.rov.Program$$lookupType", "xdc.rov"), Global.get(cap, "lookupType"));
                po.addFxn("lookupTypeByVariable", (Proto.Fxn)om.findStrict("xdc.rov.Program$$lookupTypeByVariable", "xdc.rov"), Global.get(cap, "lookupTypeByVariable"));
                po.addFxn("lookupSymbolValue", (Proto.Fxn)om.findStrict("xdc.rov.Program$$lookupSymbolValue", "xdc.rov"), Global.get(cap, "lookupSymbolValue"));
                ...
                po.addFxn("addCMod", (Proto.Fxn)om.findStrict("xdc.rov.Program$$addCMod", "xdc.rov"), Global.get(cap, "addCMod"));
