...
public class xdc_rov_monserver
{
    ...
    void ProgressCallBack$$OBJECTS()
    {
        Proto.Obj po, spo;
        Value.Obj vo;

        po = (Proto.Obj)om.bind("xdc.rov.monserver.ProgressCallBack.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("xdc.rov.monserver.ProgressCallBack", new Value.Obj("xdc.rov.monserver.ProgressCallBack", po));
        pkgV.bind("ProgressCallBack", vo);
        // decls 
        // insts 
        Object insP = om.bind("xdc.rov.monserver.ProgressCallBack.Instance", new Proto.Obj());
        po = (Proto.Obj)om.bind("xdc.rov.monserver.ProgressCallBack$$Object", new Proto.Obj());
        om.bind("xdc.rov.monserver.ProgressCallBack.Object", new Proto.Str(po, true));
        po = (Proto.Obj)om.bind("xdc.rov.monserver.ProgressCallBack$$Params", new Proto.Obj());
        om.bind("xdc.rov.monserver.ProgressCallBack.Params", new Proto.Str(po, true));
    }
    ...
    void ProgressCallBack$$CREATES()
    {
        Proto.Fxn fxn;
        StringBuilder sb;

        fxn = (Proto.Fxn)om.bind("xdc.rov.monserver.ProgressCallBack$$create", new Proto.Fxn(om.findStrict("xdc.rov.monserver.ProgressCallBack.Module", "xdc.rov.monserver"), om.findStrict("xdc.rov.monserver.ProgressCallBack.Instance", "xdc.rov.monserver"), 1, 0, false));
                fxn.addArg(0, "__params", (Proto)om.findStrict("xdc.rov.monserver.ProgressCallBack.Params", "xdc.rov.monserver"), Global.newObject());
        sb = new StringBuilder();
        sb.append("xdc$rov$monserver$ProgressCallBack$$create = function( __params ) {\n");
            sb.append("var __mod = xdc.om['xdc.rov.monserver.ProgressCallBack'];\n");
            sb.append("var __inst = xdc.om['xdc.rov.monserver.ProgressCallBack.Instance'].$$make();\n");
            sb.append("__inst.$$bind('$package', xdc.om['xdc.rov.monserver']);\n");
            sb.append("__inst.$$bind('$index', __mod.$instances.length);\n");
            sb.append("__inst.$$bind('$category', 'Instance');\n");
            sb.append("__inst.$$bind('$args', {});\n");
            sb.append("__inst.$$bind('$module', __mod);\n");
            sb.append("__mod.$instances.$add(__inst);\n");
            sb.append("__inst.args = __mod.PARAMS.args;\n");
            sb.append("for (var __p in __params) __inst[__p] = __params[__p];\n");
            sb.append("var save = xdc.om.$curpkg;\n");
            sb.append("xdc.om.$$bind('$curpkg', __mod.$package.$name);\n");
            sb.append("__mod.instance$meta$init.$fxn.apply(__inst, []);\n");
        ...
        sb.append("}\n");
        Global.eval(sb.toString());
        fxn = (Proto.Fxn)om.bind("xdc.rov.monserver.ProgressCallBack$$construct", new Proto.Fxn(om.findStrict("xdc.rov.monserver.ProgressCallBack.Module", "xdc.rov.monserver"), null, 2, 0, false));
                fxn.addArg(0, "__obj", (Proto)om.findStrict("xdc.rov.monserver.ProgressCallBack$$Object", "xdc.rov.monserver"), null);
                fxn.addArg(1, "__params", (Proto)om.findStrict("xdc.rov.monserver.ProgressCallBack.Params", "xdc.rov.monserver"), Global.newObject());
        sb = new StringBuilder();
        sb.append("xdc$rov$monserver$ProgressCallBack$$construct = function( __obj, __params ) {\n");
            sb.append("var __mod = xdc.om['xdc.rov.monserver.ProgressCallBack'];\n");
            sb.append("var __inst = __obj;\n");
            sb.append("__inst.$$bind('$args', {});\n");
            sb.append("__inst.$$bind('$module', __mod);\n");
    ...
    void ProgressCallBack$$FUNCTIONS()
    {
        Proto.Fxn fxn;
    ...
    void ProgressCallBack$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "xdc/rov/monserver/ProgressCallBack.xs");
        om.bind("xdc.rov.monserver.ProgressCallBack$$capsule", cap);
        po = (Proto.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack.Module", "xdc.rov.monserver");
        po.init("xdc.rov.monserver.ProgressCallBack.Module", om.findStrict("xdc.rov.ICallBack.Module", "xdc.rov.monserver"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFxn("create", (Proto.Fxn)om.findStrict("xdc.rov.monserver.ProgressCallBack$$create", "xdc.rov.monserver"), Global.get("xdc$rov$monserver$ProgressCallBack$$create"));
                po.addFxn("construct", (Proto.Fxn)om.findStrict("xdc.rov.monserver.ProgressCallBack$$construct", "xdc.rov.monserver"), Global.get("xdc$rov$monserver$ProgressCallBack$$construct"));
        fxn = Global.get(cap, "module$use");
        if (fxn != null) om.bind("xdc.rov.monserver.ProgressCallBack$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("xdc.rov.monserver.ProgressCallBack$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "instance$meta$init");
        if (fxn != null) om.bind("xdc.rov.monserver.ProgressCallBack$$instance$meta$init", true);
        if (fxn != null) po.addFxn("instance$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("xdc.rov.monserver.ProgressCallBack$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
        po = (Proto.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack.Instance", "xdc.rov.monserver");
        po.init("xdc.rov.monserver.ProgressCallBack.Instance", om.findStrict("xdc.rov.ICallBack.Instance", "xdc.rov.monserver"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("args", $$T_Obj, $$UNDEF, "wh");
        ...
        po = (Proto.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack$$Params", "xdc.rov.monserver");
        po.init("xdc.rov.monserver.ProgressCallBack.Params", om.findStrict("xdc.rov.ICallBack$$Params", "xdc.rov.monserver"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("args", $$T_Obj, $$UNDEF, "wh");
        po = (Proto.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack$$Object", "xdc.rov.monserver");
        po.init("xdc.rov.monserver.ProgressCallBack.Object", om.findStrict("xdc.rov.monserver.ProgressCallBack.Instance", "xdc.rov.monserver"));
                fxn = Global.get(cap, "updateStartupProgress");
                if (fxn != null) po.addFxn("updateStartupProgress", (Proto.Fxn)om.findStrict("xdc.rov.ICallBack$$updateStartupProgress", "xdc.rov.monserver"), fxn);
                fxn = Global.get(cap, "getAbortFlag");
                if (fxn != null) po.addFxn("getAbortFlag", (Proto.Fxn)om.findStrict("xdc.rov.ICallBack$$getAbortFlag", "xdc.rov.monserver"), fxn);
    ...
    void ProgressCallBack$$SINGLETONS()
    {
        Proto.Obj po;
        Value.Obj vo;

        vo = (Value.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack", "xdc.rov.monserver");
        po = (Proto.Obj)om.findStrict("xdc.rov.monserver.ProgressCallBack.Module", "xdc.rov.monserver");
        vo.init2(po, "xdc.rov.monserver.ProgressCallBack", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("xdc.rov.monserver.ProgressCallBack$$capsule", "xdc.rov.monserver"));
        vo.bind("Instance", om.findStrict("xdc.rov.monserver.ProgressCallBack.Instance", "xdc.rov.monserver"));
        vo.bind("Params", om.findStrict("xdc.rov.monserver.ProgressCallBack.Params", "xdc.rov.monserver"));
        vo.bind("PARAMS", ((Proto.Str)om.findStrict("xdc.rov.monserver.ProgressCallBack.Params", "xdc.rov.monserver")).newInstance());
        vo.bind("$package", om.findStrict("xdc.rov.monserver", "xdc.rov.monserver"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        ...
        Proto.Str ps = (Proto.Str)vo.find("Module_State");
        if (ps != null) vo.bind("$object", ps.newInstance());
        vo.bind("$$meta_iobj", om.has("xdc.rov.monserver.ProgressCallBack$$instance$static$init", null) ? 1 : 0);
        vo.bind("$$fxntab", Global.newArray());
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.seal("length");
        vo.bind("Object", om.findStrict("xdc.rov.monserver.ProgressCallBack.Object", "xdc.rov.monserver"));
        pkgV.bind("ProgressCallBack", vo);
        ((Value.Arr)pkgV.getv("$unitNames")).add("ProgressCallBack");
    }
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("xdc.rov.monserver.ProgressCallBack", "xdc.rov.monserver"));
        ...
        ((Value.Obj)om.getv("xdc.rov.monserver.ProgressCallBack")).bless();
    ...
    public void exec( Scriptable xdcO, Session ses )
    {
        ...
        Main$$OBJECTS();
        CallStack$$OBJECTS();
        ProgressCallBack$$OBJECTS();
        Support$$OBJECTS();
        SymbolTable$$OBJECTS();
        Main$$CONSTS();
        CallStack$$CONSTS();
        ProgressCallBack$$CONSTS();
        Support$$CONSTS();
        SymbolTable$$CONSTS();
        Main$$CREATES();
        CallStack$$CREATES();
        ProgressCallBack$$CREATES();
        Support$$CREATES();
        SymbolTable$$CREATES();
        Main$$FUNCTIONS();
        CallStack$$FUNCTIONS();
        ProgressCallBack$$FUNCTIONS();
        Support$$FUNCTIONS();
        SymbolTable$$FUNCTIONS();
        Main$$SIZES();
        CallStack$$SIZES();
        ProgressCallBack$$SIZES();
        Support$$SIZES();
        SymbolTable$$SIZES();
        Main$$TYPES();
        CallStack$$TYPES();
        ProgressCallBack$$TYPES();
        Support$$TYPES();
        SymbolTable$$TYPES();
        if (isROV) {
            Main$$ROV();
            CallStack$$ROV();
            ProgressCallBack$$ROV();
            Support$$ROV();
            SymbolTable$$ROV();
        }//isROV
        $$SINGLETONS();
