...
public class xdc_rov_runtime
{
    ...
    void Monitor$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("xdc.rov.runtime.Monitor$$ConsoleEntryView", new Proto.Obj());
        om.bind("xdc.rov.runtime.Monitor.ConsoleEntryView", new Proto.Str(spo, false));
    ...
    void Monitor$$FUNCTIONS()
    {
        ...
        // fxn Monitor.print
        fxn = (Proto.Fxn)om.bind("xdc.rov.runtime.Monitor$$print", new Proto.Fxn(om.findStrict("xdc.rov.runtime.Monitor.Module", "xdc.rov.runtime"), null, 1, 1, true));
                fxn.addArg(0, "str", $$T_Str, $$UNDEF);
        // fxn Monitor.println
        fxn = (Proto.Fxn)om.bind("xdc.rov.runtime.Monitor$$println", new Proto.Fxn(om.findStrict("xdc.rov.runtime.Monitor.Module", "xdc.rov.runtime"), null, 1, 1, true));
                fxn.addArg(0, "str", $$T_Str, $$UNDEF);
    }
    ...
    void Monitor$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                po.addFxn("print", (Proto.Fxn)om.findStrict("xdc.rov.runtime.Monitor$$print", "xdc.rov.runtime"), Global.get(cap, "print"));
                po.addFxn("println", (Proto.Fxn)om.findStrict("xdc.rov.runtime.Monitor$$println", "xdc.rov.runtime"), Global.get(cap, "println"));
        ...
        // struct Monitor.ConsoleEntryView
        po = (Proto.Obj)om.findStrict("xdc.rov.runtime.Monitor$$ConsoleEntryView", "xdc.rov.runtime");
        po.init("xdc.rov.runtime.Monitor.ConsoleEntryView", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("lineId", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/xdc.rov.runtime.am4fg',\n");
            sb.append("'lib/xdc.rov.runtime.aem4f',\n");
            sb.append("'lib/xdc.rov.runtime.am3g',\n");
            sb.append("'lib/xdc.rov.runtime.aem3',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/xdc.rov.runtime.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/xdc.rov.runtime.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/xdc.rov.runtime.am3g', {target: 'gnu.targets.arm.M3', suffix: 'm3g'}],\n");
            sb.append("['lib/xdc.rov.runtime.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
        sb.append("];\n");
    ...
    void Monitor$$SINGLETONS()
    {
        ...
        vo.bind("ConsoleEntryView", om.findStrict("xdc.rov.runtime.Monitor.ConsoleEntryView", "xdc.rov.runtime"));
        tdefs.add(om.findStrict("xdc.rov.runtime.Monitor.ConsoleEntryView", "xdc.rov.runtime"));
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("xdc.rov.runtime.Monitor", "xdc.rov.runtime");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("argsMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"VariableNameOrAddr", Global.newObject("description", "Variable Name/Address", "args", Global.newArray(new Object[]{Global.newObject("name", "name/addr", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))}), Global.newArray(new Object[]{"ReadMemory", Global.newObject("description", "Memory Read Settings", "args", Global.newArray(new Object[]{Global.newObject("name", "addr/name", "type", "number", "defaultValue", "0"), Global.newObject("name", "length", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))}), Global.newArray(new Object[]{"FindSymbols", Global.newObject("description", "Find Symbol Settings", "args", Global.newArray(new Object[]{Global.newObject("name", "addr/name", "type", "number", "defaultValue", "0"), Global.newObject("name", "radius", "type", "number", "defaultValue", "0"), Global.newObject("name", "check", "type", "boolean", "defaultValue", "true")}))}), Global.newArray(new Object[]{"ConsoleFilter", Global.newObject("description", "Console Settings", "args", Global.newArray(new Object[]{Global.newObject("name", "filter", "type", "string", "defaultValue", ""), Global.newObject("name", "regexp", "type", "boolean", "defaultValue", "false"), Global.newObject("name", "maxLines", "type", "number", "defaultValue", "1000")}))})}), "viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Module", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE"), "viewInitFxn", "viewInitModule", "structName", "ModuleView")}), Global.newArray(new Object[]{"Variable", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE"), "viewInitFxn", "viewInitVariable", "structName", "VariableView", "argsName", "VariableNameOrAddr")}), Global.newArray(new Object[]{"UChar", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitUChar", "structName", "UCharView", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Bits16", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBits16", "structName", "Bits16View", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Bits32", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBits32", "structName", "Bits32View", "argsName", "ReadMemory")}), Global.newArray(new Object[]{"Sections", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitSections", "structName", "SectionView")}), Global.newArray(new Object[]{"Symbols", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitSymbols", "structName", "SymbolView", "argsName", "FindSymbols")}), Global.newArray(new Object[]{"Console", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitConsole", "structName", "ConsoleEntryView", "argsName", "ConsoleFilter")})}))));
        }//isCFG
