...
public class xdc_tools_sg_swt_win32
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("xdc.tools.sg.swt_win32.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("xdc.tools.sg.swt_win32", new Value.Obj("xdc.tools.sg.swt_win32", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("xdc.tools.sg.swt_win32.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "xdc.tools.sg.swt_win32"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "xdc.tools.sg.swt_win32", Value.DEFAULT, false);
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "xdc.tools.sg.swt_win32")).add(pkgV);
    }
