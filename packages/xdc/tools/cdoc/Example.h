...
#ifdef xdc_tools_cdoc_Example_Module__diagsEnabled__CR
#define xdc_tools_cdoc_Example_Module__diagsEnabled__C (*((CT__xdc_tools_cdoc_Example_Module__diagsEnabled*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__diagsEnabled__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__diagsEnabled (xdc_tools_cdoc_Example_Module__diagsEnabled__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__diagsIncluded__CR
#define xdc_tools_cdoc_Example_Module__diagsIncluded__C (*((CT__xdc_tools_cdoc_Example_Module__diagsIncluded*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__diagsIncluded__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__diagsIncluded (xdc_tools_cdoc_Example_Module__diagsIncluded__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__diagsMask__CR
#define xdc_tools_cdoc_Example_Module__diagsMask__C (*((CT__xdc_tools_cdoc_Example_Module__diagsMask*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__diagsMask__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__diagsMask (xdc_tools_cdoc_Example_Module__diagsMask__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__gateObj__CR
#define xdc_tools_cdoc_Example_Module__gateObj__C (*((CT__xdc_tools_cdoc_Example_Module__gateObj*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__gateObj__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__gateObj (xdc_tools_cdoc_Example_Module__gateObj__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__gatePrms__CR
#define xdc_tools_cdoc_Example_Module__gatePrms__C (*((CT__xdc_tools_cdoc_Example_Module__gatePrms*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__gatePrms__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__gatePrms (xdc_tools_cdoc_Example_Module__gatePrms__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__id__CR
#define xdc_tools_cdoc_Example_Module__id__C (*((CT__xdc_tools_cdoc_Example_Module__id*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__id__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__id (xdc_tools_cdoc_Example_Module__id__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerDefined__CR
#define xdc_tools_cdoc_Example_Module__loggerDefined__C (*((CT__xdc_tools_cdoc_Example_Module__loggerDefined*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerDefined__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerDefined (xdc_tools_cdoc_Example_Module__loggerDefined__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerObj__CR
#define xdc_tools_cdoc_Example_Module__loggerObj__C (*((CT__xdc_tools_cdoc_Example_Module__loggerObj*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerObj__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerObj (xdc_tools_cdoc_Example_Module__loggerObj__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerFxn0__CR
#define xdc_tools_cdoc_Example_Module__loggerFxn0__C (*((CT__xdc_tools_cdoc_Example_Module__loggerFxn0*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerFxn0__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerFxn0 (xdc_tools_cdoc_Example_Module__loggerFxn0__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerFxn1__CR
#define xdc_tools_cdoc_Example_Module__loggerFxn1__C (*((CT__xdc_tools_cdoc_Example_Module__loggerFxn1*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerFxn1__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerFxn1 (xdc_tools_cdoc_Example_Module__loggerFxn1__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerFxn2__CR
#define xdc_tools_cdoc_Example_Module__loggerFxn2__C (*((CT__xdc_tools_cdoc_Example_Module__loggerFxn2*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerFxn2__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerFxn2 (xdc_tools_cdoc_Example_Module__loggerFxn2__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerFxn4__CR
#define xdc_tools_cdoc_Example_Module__loggerFxn4__C (*((CT__xdc_tools_cdoc_Example_Module__loggerFxn4*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerFxn4__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerFxn4 (xdc_tools_cdoc_Example_Module__loggerFxn4__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Module__loggerFxn8__CR
#define xdc_tools_cdoc_Example_Module__loggerFxn8__C (*((CT__xdc_tools_cdoc_Example_Module__loggerFxn8*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Module__loggerFxn8__C_offset)))
#else
#define xdc_tools_cdoc_Example_Module__loggerFxn8 (xdc_tools_cdoc_Example_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Object__count__CR
#define xdc_tools_cdoc_Example_Object__count__C (*((CT__xdc_tools_cdoc_Example_Object__count*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Object__count__C_offset)))
#else
#define xdc_tools_cdoc_Example_Object__count (xdc_tools_cdoc_Example_Object__count__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Object__heap__CR
#define xdc_tools_cdoc_Example_Object__heap__C (*((CT__xdc_tools_cdoc_Example_Object__heap*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Object__heap__C_offset)))
#else
#define xdc_tools_cdoc_Example_Object__heap (xdc_tools_cdoc_Example_Object__heap__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Object__sizeof__CR
#define xdc_tools_cdoc_Example_Object__sizeof__C (*((CT__xdc_tools_cdoc_Example_Object__sizeof*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Object__sizeof__C_offset)))
#else
#define xdc_tools_cdoc_Example_Object__sizeof (xdc_tools_cdoc_Example_Object__sizeof__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_Object__table__CR
#define xdc_tools_cdoc_Example_Object__table__C (*((CT__xdc_tools_cdoc_Example_Object__table*)(xdcRomConstPtr + xdc_tools_cdoc_Example_Object__table__C_offset)))
#else
#define xdc_tools_cdoc_Example_Object__table (xdc_tools_cdoc_Example_Object__table__C)
#endif
...
#ifdef xdc_tools_cdoc_Example_u__CR
#define xdc_tools_cdoc_Example_u (*((CT__xdc_tools_cdoc_Example_u*)(xdcRomConstPtr + xdc_tools_cdoc_Example_u__C_offset)))
#else
...
static inline xdc_Bool xdc_tools_cdoc_Example_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_tools_cdoc_Example_Module__diagsMask__C != (CT__xdc_tools_cdoc_Example_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_tools_cdoc_Example_Module_getMask(void)
{
    return (xdc_tools_cdoc_Example_Module__diagsMask__C != (CT__xdc_tools_cdoc_Example_Module__diagsMask)NULL) ? *xdc_tools_cdoc_Example_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_tools_cdoc_Example_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_tools_cdoc_Example_Module__diagsMask__C != (CT__xdc_tools_cdoc_Example_Module__diagsMask)NULL) {
        *xdc_tools_cdoc_Example_Module__diagsMask__C = mask;
    }
}
