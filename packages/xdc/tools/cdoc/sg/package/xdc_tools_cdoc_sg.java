...
public class xdc_tools_cdoc_sg
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('xdc.tools.cdoc.sg$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['xdc.tools.cdoc.sg$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['xdc.tools.cdoc.sg$$stat$root'];\n");
        sb.append("}\n");
