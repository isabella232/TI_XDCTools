...
typedef xdc_Char *ARRAY1_xdc_runtime_HeapMin_Instance_State__buf;
typedef const xdc_Char *CARRAY1_xdc_runtime_HeapMin_Instance_State__buf;
typedef ARRAY1_xdc_runtime_HeapMin_Instance_State__buf __TA_xdc_runtime_HeapMin_Instance_State__buf;
...
struct xdc_runtime_HeapMin_Struct {
    ...
    __TA_xdc_runtime_HeapMin_Instance_State__buf f0;
    xdc_runtime_Memory_Size f1;
    xdc_runtime_Memory_Size f2;
...
struct xdc_runtime_HeapMin_Fxns__ {
    ...
    xdc_Ptr (*alloc)(xdc_runtime_HeapMin_Handle inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(xdc_runtime_HeapMin_Handle inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(xdc_runtime_HeapMin_Handle inst);
    xdc_Void (*getStats)(xdc_runtime_HeapMin_Handle inst, xdc_runtime_Memory_Stats* stats);
...
__extern xdc_Void xdc_runtime_HeapMin_Instance_init__E(xdc_runtime_HeapMin_Object *obj, const xdc_runtime_HeapMin_Params *prms);

/* create */
xdc__CODESECT(xdc_runtime_HeapMin_create, "xdc_runtime_HeapMin_create")
__extern xdc_runtime_HeapMin_Handle xdc_runtime_HeapMin_create( const xdc_runtime_HeapMin_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(xdc_runtime_HeapMin_construct, "xdc_runtime_HeapMin_construct")
__extern void xdc_runtime_HeapMin_construct(xdc_runtime_HeapMin_Struct *obj, const xdc_runtime_HeapMin_Params *prms);
...
__extern xdc_Ptr xdc_runtime_HeapMin_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);
...
__extern xdc_Void xdc_runtime_HeapMin_getStats__E( xdc_runtime_HeapMin_Handle instp, xdc_runtime_Memory_Stats *stats);
...
__extern xdc_Ptr xdc_runtime_HeapMin_alloc__E( xdc_runtime_HeapMin_Handle instp, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block *eb);
...
__extern xdc_Void xdc_runtime_HeapMin_free__E( xdc_runtime_HeapMin_Handle instp, xdc_Ptr block, xdc_SizeT size);
...
__extern xdc_Bool xdc_runtime_HeapMin_isBlocking__E( xdc_runtime_HeapMin_Handle instp);
...
static inline xdc_runtime_HeapMin_Handle xdc_runtime_HeapMin_Handle_downCast(xdc_runtime_IHeap_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&xdc_runtime_HeapMin_Module__FXNS__C) ? (xdc_runtime_HeapMin_Handle)i : (xdc_runtime_HeapMin_Handle)NULL;
}
...
static inline xdc_Bool xdc_runtime_HeapMin_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_HeapMin_Module__diagsMask__C != (CT__xdc_runtime_HeapMin_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_HeapMin_Module_getMask(void)
{
    return (xdc_runtime_HeapMin_Module__diagsMask__C != (CT__xdc_runtime_HeapMin_Module__diagsMask)NULL) ? *xdc_runtime_HeapMin_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_HeapMin_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_HeapMin_Module__diagsMask__C != (CT__xdc_runtime_HeapMin_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        xdc_runtime_HeapMin_Params__init__S(prms, NULL, sizeof(xdc_runtime_HeapMin_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_HeapMin_Handle xdc_runtime_HeapMin_Object_get(xdc_runtime_HeapMin_Object *oarr, int i);
static inline xdc_runtime_HeapMin_Handle xdc_runtime_HeapMin_Object_get(xdc_runtime_HeapMin_Object *oarr, int i) 
{
