...
module Diags {
    ...
    const Mask ENTRY        = 0x0001U;   //! Function entry
    const Mask EXIT         = 0x0002U;   //! Function exit
    const Mask LIFECYCLE    = 0x0004U;   //! Object life-cycle
    const Mask INTERNAL     = 0x0008U;   //! Internal diagnostics

    const Mask ASSERT       = 0x0010U;   //! Assert checking

    const Mask STATUS       = 0x0080U;   //! Warning or error event

    /*! @_nodoc */
    const Mask LEVEL        = 0x0060U;   //! Mask to retrieve the level bits

    const Mask USER1        = 0x0100U;   //! User defined diagnostics
    const Mask USER2        = 0x0200U;   //! User defined diagnostics
    const Mask USER3        = 0x0400U;   //! User defined diagnostics
    const Mask USER4        = 0x0800U;   //! User defined diagnostics

    const Mask USER5        = 0x1000U;   //! User defined diagnostics
    const Mask USER6        = 0x2000U;   //! User defined diagnostics
    const Mask USER7        = 0x4000U;   //! Alias for informational event
    const Mask INFO         = USER7;     //! Informational event
    const Mask USER8        = 0x8000U;   //! Alias for analysis event
