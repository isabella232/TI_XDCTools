...
/* OutputFxn */
typedef xdc_Void (*xdc_runtime_SysMin_OutputFxn)(xdc_Char* arg1, xdc_UInt arg2);
...
typedef xdc_Char *ARRAY1_xdc_runtime_SysMin_Module_State__outbuf;
typedef const xdc_Char *CARRAY1_xdc_runtime_SysMin_Module_State__outbuf;
typedef ARRAY1_xdc_runtime_SysMin_Module_State__outbuf __TA_xdc_runtime_SysMin_Module_State__outbuf;
...
static inline xdc_Bool xdc_runtime_SysMin_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_SysMin_Module__diagsMask__C != (CT__xdc_runtime_SysMin_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_SysMin_Module_getMask(void)
{
    return (xdc_runtime_SysMin_Module__diagsMask__C != (CT__xdc_runtime_SysMin_Module__diagsMask)NULL) ? *xdc_runtime_SysMin_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_SysMin_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_SysMin_Module__diagsMask__C != (CT__xdc_runtime_SysMin_Module__diagsMask)NULL) {
