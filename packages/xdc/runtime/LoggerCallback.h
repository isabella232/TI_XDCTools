...
/* OutputFxn */
typedef xdc_Void (*xdc_runtime_LoggerCallback_OutputFxn)(xdc_UArg arg1, xdc_runtime_Log_EventRec* arg2, xdc_Int arg3);

/* defaultOutput */
__extern xdc_Void xdc_runtime_LoggerCallback_defaultOutput(xdc_UArg arg1, xdc_runtime_Log_EventRec* arg2, xdc_Int arg3);

/* CreateInstFxn */
typedef xdc_UArg (*xdc_runtime_LoggerCallback_CreateInstFxn)(xdc_UArg arg1);

/* defaultCreate */
__extern xdc_UArg xdc_runtime_LoggerCallback_defaultCreate(xdc_UArg arg1);
...
struct xdc_runtime_LoggerCallback_Fxns__ {
    ...
    xdc_Bool (*enable)(xdc_runtime_LoggerCallback_Handle inst);
    xdc_Bool (*disable)(xdc_runtime_LoggerCallback_Handle inst);
    xdc_Void (*write0)(xdc_runtime_LoggerCallback_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
    xdc_Void (*write1)(xdc_runtime_LoggerCallback_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
    xdc_Void (*write2)(xdc_runtime_LoggerCallback_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
    xdc_Void (*write4)(xdc_runtime_LoggerCallback_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
    xdc_Void (*write8)(xdc_runtime_LoggerCallback_Handle inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
...
__extern xdc_Void xdc_runtime_LoggerCallback_Instance_init__E(xdc_runtime_LoggerCallback_Object *obj, const xdc_runtime_LoggerCallback_Params *prms);

/* create */
xdc__CODESECT(xdc_runtime_LoggerCallback_create, "xdc_runtime_LoggerCallback_create")
__extern xdc_runtime_LoggerCallback_Handle xdc_runtime_LoggerCallback_create( const xdc_runtime_LoggerCallback_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(xdc_runtime_LoggerCallback_construct, "xdc_runtime_LoggerCallback_construct")
__extern void xdc_runtime_LoggerCallback_construct(xdc_runtime_LoggerCallback_Struct *obj, const xdc_runtime_LoggerCallback_Params *prms);
...
__extern xdc_Ptr xdc_runtime_LoggerCallback_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_LoggerCallback_enable__E( xdc_runtime_LoggerCallback_Handle instp);
...
__extern xdc_Bool xdc_runtime_LoggerCallback_disable__E( xdc_runtime_LoggerCallback_Handle instp);
...
__extern xdc_Void xdc_runtime_LoggerCallback_write0__E( xdc_runtime_LoggerCallback_Handle instp, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
...
__extern xdc_Void xdc_runtime_LoggerCallback_write1__E( xdc_runtime_LoggerCallback_Handle instp, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
...
__extern xdc_Void xdc_runtime_LoggerCallback_write2__E( xdc_runtime_LoggerCallback_Handle instp, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
...
__extern xdc_Void xdc_runtime_LoggerCallback_write4__E( xdc_runtime_LoggerCallback_Handle instp, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
...
__extern xdc_Void xdc_runtime_LoggerCallback_write8__E( xdc_runtime_LoggerCallback_Handle instp, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
...
static inline xdc_runtime_LoggerCallback_Handle xdc_runtime_LoggerCallback_Handle_downCast(xdc_runtime_ILogger_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&xdc_runtime_LoggerCallback_Module__FXNS__C) ? (xdc_runtime_LoggerCallback_Handle)i : (xdc_runtime_LoggerCallback_Handle)NULL;
}
...
static inline xdc_Bool xdc_runtime_LoggerCallback_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_LoggerCallback_Module__diagsMask__C != (CT__xdc_runtime_LoggerCallback_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_LoggerCallback_Module_getMask(void)
{
    return (xdc_runtime_LoggerCallback_Module__diagsMask__C != (CT__xdc_runtime_LoggerCallback_Module__diagsMask)NULL) ? *xdc_runtime_LoggerCallback_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_LoggerCallback_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_LoggerCallback_Module__diagsMask__C != (CT__xdc_runtime_LoggerCallback_Module__diagsMask)NULL) {
...
{
    if (prms != NULL) {
        xdc_runtime_LoggerCallback_Params__init__S(prms, NULL, sizeof(xdc_runtime_LoggerCallback_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_LoggerCallback_Handle xdc_runtime_LoggerCallback_Object_get(xdc_runtime_LoggerCallback_Object *oarr, int i);
static inline xdc_runtime_LoggerCallback_Handle xdc_runtime_LoggerCallback_Object_get(xdc_runtime_LoggerCallback_Object *oarr, int i) 
{
