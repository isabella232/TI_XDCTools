...
/* AbortFxn */
typedef xdc_Void (*xdc_runtime_SysCallback_AbortFxn)(xdc_CString arg1);

/* defaultAbort */
__extern xdc_Void xdc_runtime_SysCallback_defaultAbort(xdc_CString arg1);

/* ExitFxn */
typedef xdc_Void (*xdc_runtime_SysCallback_ExitFxn)(xdc_Int arg1);

/* defaultExit */
__extern xdc_Void xdc_runtime_SysCallback_defaultExit(xdc_Int arg1);
...
/* PutchFxn */
typedef xdc_Void (*xdc_runtime_SysCallback_PutchFxn)(xdc_Char arg1);

/* defaultPutch */
__extern xdc_Void xdc_runtime_SysCallback_defaultPutch(xdc_Char arg1);
...
static inline xdc_Bool xdc_runtime_SysCallback_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_SysCallback_Module__diagsMask__C != (CT__xdc_runtime_SysCallback_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_SysCallback_Module_getMask(void)
{
    return (xdc_runtime_SysCallback_Module__diagsMask__C != (CT__xdc_runtime_SysCallback_Module__diagsMask)NULL) ? *xdc_runtime_SysCallback_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_SysCallback_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_SysCallback_Module__diagsMask__C != (CT__xdc_runtime_SysCallback_Module__diagsMask)NULL) {
