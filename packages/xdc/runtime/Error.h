...
/* HookFxn */
typedef xdc_Void (*xdc_runtime_Error_HookFxn)(xdc_runtime_Error_Block* arg1);
...
typedef xdc_IArg ARRAY1_xdc_runtime_Error_Data__arg[2];
typedef xdc_IArg CARRAY1_xdc_runtime_Error_Data__arg[2];
typedef CARRAY1_xdc_runtime_Error_Data__arg __TA_xdc_runtime_Error_Data__arg;
...
/* PolicyFxn */
typedef xdc_Void (*xdc_runtime_Error_PolicyFxn)(xdc_runtime_Error_Block* arg1, xdc_runtime_Types_ModuleId arg2, xdc_CString arg3, xdc_Int arg4, xdc_runtime_Error_Id arg5, xdc_IArg arg6, xdc_IArg arg7);
...
static inline xdc_Bool xdc_runtime_Error_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_Error_Module__diagsMask__C != (CT__xdc_runtime_Error_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_Error_Module_getMask(void)
{
    return (xdc_runtime_Error_Module__diagsMask__C != (CT__xdc_runtime_Error_Module__diagsMask)NULL) ? *xdc_runtime_Error_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_Error_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_Error_Module__diagsMask__C != (CT__xdc_runtime_Error_Module__diagsMask)NULL) {
