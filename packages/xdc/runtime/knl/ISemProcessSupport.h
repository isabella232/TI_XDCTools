...
struct xdc_runtime_knl_ISemProcessSupport_Fxns__ {
    ...
    xdc_Int (*pend)(void* inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
    xdc_Bool (*post)(void* inst, xdc_runtime_Error_Block* eb);
...
__extern xdc_runtime_knl_ISemProcessSupport_Handle xdc_runtime_knl_ISemProcessSupport_create(xdc_runtime_knl_ISemProcessSupport_Module mod, xdc_Int count, xdc_Int key, const xdc_runtime_knl_ISemProcessSupport_Params *prms, xdc_runtime_Error_Block *eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISemProcessSupport_delete, "xdc_runtime_knl_ISemProcessSupport_delete")
__extern xdc_Void xdc_runtime_knl_ISemProcessSupport_delete(xdc_runtime_knl_ISemProcessSupport_Handle *inst);
...
/* pend */
static inline xdc_Int xdc_runtime_knl_ISemProcessSupport_pend(xdc_runtime_knl_ISemProcessSupport_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
static inline xdc_Int xdc_runtime_knl_ISemProcessSupport_pend( xdc_runtime_knl_ISemProcessSupport_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block *eb )
{
    return inst->__fxns->pend((void*)inst, timeout, eb);
}

/* post */
static inline xdc_Bool xdc_runtime_knl_ISemProcessSupport_post(xdc_runtime_knl_ISemProcessSupport_Handle inst, xdc_runtime_Error_Block *eb);
static inline xdc_Bool xdc_runtime_knl_ISemProcessSupport_post( xdc_runtime_knl_ISemProcessSupport_Handle inst, xdc_runtime_Error_Block *eb )
{
    return inst->__fxns->post((void*)inst, eb);
}
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemProcessSupport_pend_FxnT)(xdc_Void *inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
static inline xdc_runtime_knl_ISemProcessSupport_pend_FxnT xdc_runtime_knl_ISemProcessSupport_pend_fxnP(xdc_runtime_knl_ISemProcessSupport_Handle inst);
static inline xdc_runtime_knl_ISemProcessSupport_pend_FxnT xdc_runtime_knl_ISemProcessSupport_pend_fxnP(xdc_runtime_knl_ISemProcessSupport_Handle inst)
{
    return (xdc_runtime_knl_ISemProcessSupport_pend_FxnT)inst->__fxns->pend;
}

/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemProcessSupport_post_FxnT)(xdc_Void *inst, xdc_runtime_Error_Block* eb);
static inline xdc_runtime_knl_ISemProcessSupport_post_FxnT xdc_runtime_knl_ISemProcessSupport_post_fxnP(xdc_runtime_knl_ISemProcessSupport_Handle inst);
static inline xdc_runtime_knl_ISemProcessSupport_post_FxnT xdc_runtime_knl_ISemProcessSupport_post_fxnP(xdc_runtime_knl_ISemProcessSupport_Handle inst)
{
    return (xdc_runtime_knl_ISemProcessSupport_post_FxnT)inst->__fxns->post;
}
