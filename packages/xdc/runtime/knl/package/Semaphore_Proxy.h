...
struct xdc_runtime_knl_Semaphore_Proxy_Fxns__ {
    ...
    xdc_Int (*pend)(xdc_runtime_knl_Semaphore_Proxy_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
    xdc_Bool (*post)(xdc_runtime_knl_Semaphore_Proxy_Handle inst, xdc_runtime_Error_Block* eb);
...
__extern xdc_Int xdc_runtime_knl_Semaphore_Proxy_pend__E( xdc_runtime_knl_Semaphore_Proxy_Handle instp, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Semaphore_Proxy_post__E( xdc_runtime_knl_Semaphore_Proxy_Handle instp, xdc_runtime_Error_Block *eb);
...
static inline xdc_runtime_knl_Semaphore_Proxy_Handle xdc_runtime_knl_Semaphore_Proxy_Handle_downCast(xdc_runtime_knl_ISemaphore_Handle i)
{
    ...
    if (xdc_runtime_knl_Semaphore_Proxy_Proxy__abstract__S() != 0U) {
        return (xdc_runtime_knl_Semaphore_Proxy_Handle)i;
    }
    return ((const void*)i2->__fxns == (const void*)xdc_runtime_knl_Semaphore_Proxy_Proxy__delegate__S()) ? (xdc_runtime_knl_Semaphore_Proxy_Handle)i : (xdc_runtime_knl_Semaphore_Proxy_Handle)NULL;
}
...
{
    if (prms != NULL) {
        xdc_runtime_knl_Semaphore_Proxy_Params__init__S(prms, NULL, sizeof(xdc_runtime_knl_Semaphore_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
