...
__extern xdc_Bool xdc_runtime_knl_Sync_Proxy_query__E( xdc_runtime_knl_Sync_Proxy_Handle instp, xdc_Int qual);
...
__extern xdc_Void xdc_runtime_knl_Sync_Proxy_signal__E( xdc_runtime_knl_Sync_Proxy_Handle instp);
...
__extern xdc_Int xdc_runtime_knl_Sync_Proxy_wait__E( xdc_runtime_knl_Sync_Proxy_Handle instp, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
...
static inline xdc_runtime_knl_Sync_Proxy_Handle xdc_runtime_knl_Sync_Proxy_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    if (xdc_runtime_knl_Sync_Proxy_Proxy__abstract__S() != 0U) {
