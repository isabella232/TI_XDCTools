...
#define xdc_runtime_knl_Thread_Proxy___VERS 200
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled__CR
#define xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled (xdc_runtime_knl_Thread_Proxy_Module__diagsEnabled__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded__CR
#define xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded (xdc_runtime_knl_Thread_Proxy_Module__diagsIncluded__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__diagsMask__CR
#define xdc_runtime_knl_Thread_Proxy_Module__diagsMask__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__diagsMask (xdc_runtime_knl_Thread_Proxy_Module__diagsMask__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__gateObj__CR
#define xdc_runtime_knl_Thread_Proxy_Module__gateObj__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__gateObj__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__gateObj (xdc_runtime_knl_Thread_Proxy_Module__gateObj__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__gatePrms__CR
#define xdc_runtime_knl_Thread_Proxy_Module__gatePrms__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__gatePrms (xdc_runtime_knl_Thread_Proxy_Module__gatePrms__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__id__CR
#define xdc_runtime_knl_Thread_Proxy_Module__id__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__id*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__id__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__id (xdc_runtime_knl_Thread_Proxy_Module__id__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerDefined__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerDefined__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerDefined (xdc_runtime_knl_Thread_Proxy_Module__loggerDefined__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerObj__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerObj__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerObj (xdc_runtime_knl_Thread_Proxy_Module__loggerObj__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0 (xdc_runtime_knl_Thread_Proxy_Module__loggerFxn0__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1 (xdc_runtime_knl_Thread_Proxy_Module__loggerFxn1__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2 (xdc_runtime_knl_Thread_Proxy_Module__loggerFxn2__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4 (xdc_runtime_knl_Thread_Proxy_Module__loggerFxn4__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8__CR
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8__C (*((CT__xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8 (xdc_runtime_knl_Thread_Proxy_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Object__count__CR
#define xdc_runtime_knl_Thread_Proxy_Object__count__C (*((CT__xdc_runtime_knl_Thread_Proxy_Object__count*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Object__count__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Object__count (xdc_runtime_knl_Thread_Proxy_Object__count__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Object__heap__CR
#define xdc_runtime_knl_Thread_Proxy_Object__heap__C (*((CT__xdc_runtime_knl_Thread_Proxy_Object__heap*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Object__heap__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Object__heap (xdc_runtime_knl_Thread_Proxy_Object__heap__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Object__sizeof__CR
#define xdc_runtime_knl_Thread_Proxy_Object__sizeof__C (*((CT__xdc_runtime_knl_Thread_Proxy_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Object__sizeof__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Object__sizeof (xdc_runtime_knl_Thread_Proxy_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Proxy_Object__table__CR
#define xdc_runtime_knl_Thread_Proxy_Object__table__C (*((CT__xdc_runtime_knl_Thread_Proxy_Object__table*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Object__table__C_offset)))
#else
#define xdc_runtime_knl_Thread_Proxy_Object__table (xdc_runtime_knl_Thread_Proxy_Object__table__C)
#endif
...
struct xdc_runtime_knl_Thread_Proxy_Fxns__ {
    ...
    xdc_Bool (*join)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_runtime_Error_Block* eb);
    xdc_runtime_knl_IThreadSupport_Priority (*getPriority)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setPriority)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block* eb);
    xdc_Int (*getOsPriority)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setOsPriority)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_Int newPri, xdc_runtime_Error_Block* eb);
    xdc_Ptr (*getOsHandle)(xdc_runtime_knl_Thread_Proxy_Handle inst);
    xdc_Ptr (*getTls)(xdc_runtime_knl_Thread_Proxy_Handle inst);
    xdc_Void (*setTls)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_Ptr tls);
    xdc_Bool (*stat)(xdc_runtime_knl_Thread_Proxy_Handle inst, xdc_runtime_knl_IThreadSupport_Stat* buf, xdc_runtime_Error_Block* eb);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef xdc_runtime_knl_Thread_Proxy_Module__FXNS__CR

/* Module__FXNS__C */
__extern const xdc_runtime_knl_Thread_Proxy_Fxns__ xdc_runtime_knl_Thread_Proxy_Module__FXNS__C;
#else
#define xdc_runtime_knl_Thread_Proxy_Module__FXNS__C (*(xdcRomConstPtr + xdc_runtime_knl_Thread_Proxy_Module__FXNS__C_offset))
#endif
...
__extern xdc_runtime_knl_Thread_Proxy_Handle xdc_runtime_knl_Thread_Proxy_create( xdc_runtime_knl_IThreadSupport_RunFxn fxn, const xdc_runtime_knl_Thread_Proxy_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_CPtr xdc_runtime_knl_Thread_Proxy_Proxy__delegate__S( void);
...
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_join__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_runtime_knl_IThreadSupport_Priority xdc_runtime_knl_Thread_Proxy_getPriority__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_setPriority__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block *eb);
...
__extern xdc_Int xdc_runtime_knl_Thread_Proxy_getOsPriority__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_setOsPriority__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_Int newPri, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_getOsHandle__E( xdc_runtime_knl_Thread_Proxy_Handle instp);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_Proxy_getTls__E( xdc_runtime_knl_Thread_Proxy_Handle instp);
...
__extern xdc_Void xdc_runtime_knl_Thread_Proxy_setTls__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_Ptr tls);
...
__extern xdc_Bool xdc_runtime_knl_Thread_Proxy_stat__E( xdc_runtime_knl_Thread_Proxy_Handle instp, xdc_runtime_knl_IThreadSupport_Stat *buf, xdc_runtime_Error_Block *eb);
...
static inline xdc_runtime_knl_Thread_Proxy_Handle xdc_runtime_knl_Thread_Proxy_Handle_downCast(xdc_runtime_knl_IThreadSupport_Handle i)
{
    ...
    if (xdc_runtime_knl_Thread_Proxy_Proxy__abstract__S() != 0U) {
        return (xdc_runtime_knl_Thread_Proxy_Handle)i;
    }
    return ((const void*)i2->__fxns == (const void*)xdc_runtime_knl_Thread_Proxy_Proxy__delegate__S()) ? (xdc_runtime_knl_Thread_Proxy_Handle)i : (xdc_runtime_knl_Thread_Proxy_Handle)NULL;
}
...
{
    if (prms != NULL) {
        xdc_runtime_knl_Thread_Proxy_Params__init__S(prms, NULL, sizeof(xdc_runtime_knl_Thread_Proxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
