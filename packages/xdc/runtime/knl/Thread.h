...
#define xdc_runtime_knl_Thread___VERS 200
...
/* RunFxn */
typedef xdc_Void (*xdc_runtime_knl_Thread_RunFxn)(xdc_IArg arg1);
...
#define xdc_runtime_knl_Thread_Module__diagsEnabled__C (*((CT__xdc_runtime_knl_Thread_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__diagsEnabled (xdc_runtime_knl_Thread_Module__diagsEnabled__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__diagsIncluded__C (*((CT__xdc_runtime_knl_Thread_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__diagsIncluded (xdc_runtime_knl_Thread_Module__diagsIncluded__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__diagsMask__C (*((CT__xdc_runtime_knl_Thread_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__diagsMask (xdc_runtime_knl_Thread_Module__diagsMask__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__gateObj__C (*((CT__xdc_runtime_knl_Thread_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__gateObj__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__gateObj (xdc_runtime_knl_Thread_Module__gateObj__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__gatePrms__C (*((CT__xdc_runtime_knl_Thread_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__gatePrms (xdc_runtime_knl_Thread_Module__gatePrms__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__id__C (*((CT__xdc_runtime_knl_Thread_Module__id*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__id__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__id (xdc_runtime_knl_Thread_Module__id__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerDefined__C (*((CT__xdc_runtime_knl_Thread_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerDefined (xdc_runtime_knl_Thread_Module__loggerDefined__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerObj__C (*((CT__xdc_runtime_knl_Thread_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerObj (xdc_runtime_knl_Thread_Module__loggerObj__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerFxn0__C (*((CT__xdc_runtime_knl_Thread_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerFxn0 (xdc_runtime_knl_Thread_Module__loggerFxn0__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerFxn1__C (*((CT__xdc_runtime_knl_Thread_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerFxn1 (xdc_runtime_knl_Thread_Module__loggerFxn1__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerFxn2__C (*((CT__xdc_runtime_knl_Thread_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerFxn2 (xdc_runtime_knl_Thread_Module__loggerFxn2__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerFxn4__C (*((CT__xdc_runtime_knl_Thread_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerFxn4 (xdc_runtime_knl_Thread_Module__loggerFxn4__C)
#endif
...
#define xdc_runtime_knl_Thread_Module__loggerFxn8__C (*((CT__xdc_runtime_knl_Thread_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_knl_Thread_Module__loggerFxn8 (xdc_runtime_knl_Thread_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Object__count__CR
#define xdc_runtime_knl_Thread_Object__count__C (*((CT__xdc_runtime_knl_Thread_Object__count*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Object__count__C_offset)))
#else
#define xdc_runtime_knl_Thread_Object__count (xdc_runtime_knl_Thread_Object__count__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Object__heap__CR
#define xdc_runtime_knl_Thread_Object__heap__C (*((CT__xdc_runtime_knl_Thread_Object__heap*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Object__heap__C_offset)))
#else
#define xdc_runtime_knl_Thread_Object__heap (xdc_runtime_knl_Thread_Object__heap__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Object__sizeof__CR
#define xdc_runtime_knl_Thread_Object__sizeof__C (*((CT__xdc_runtime_knl_Thread_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Object__sizeof__C_offset)))
#else
#define xdc_runtime_knl_Thread_Object__sizeof (xdc_runtime_knl_Thread_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_Object__table__CR
#define xdc_runtime_knl_Thread_Object__table__C (*((CT__xdc_runtime_knl_Thread_Object__table*)(xdcRomConstPtr + xdc_runtime_knl_Thread_Object__table__C_offset)))
#else
#define xdc_runtime_knl_Thread_Object__table (xdc_runtime_knl_Thread_Object__table__C)
#endif
...
#ifdef xdc_runtime_knl_Thread_A_zeroTimeout__CR
#define xdc_runtime_knl_Thread_A_zeroTimeout (*((CT__xdc_runtime_knl_Thread_A_zeroTimeout*)(xdcRomConstPtr + xdc_runtime_knl_Thread_A_zeroTimeout__C_offset)))
#else
...
#ifdef xdc_runtime_knl_Thread_defaultStackSize__CR
#define xdc_runtime_knl_Thread_defaultStackSize (*((CT__xdc_runtime_knl_Thread_defaultStackSize*)(xdcRomConstPtr + xdc_runtime_knl_Thread_defaultStackSize__C_offset)))
#else
...
struct xdc_runtime_knl_Thread_Struct {
    xdc_runtime_knl_Thread_Proxy_Handle f0;
    xdc_Ptr f1;
...
__extern xdc_Int xdc_runtime_knl_Thread_Instance_init__E(xdc_runtime_knl_Thread_Object *obj, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params *prms, xdc_runtime_Error_Block *eb);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_finalize__E, "xdc_runtime_knl_Thread_Instance_finalize")
__extern void xdc_runtime_knl_Thread_Instance_finalize__E(xdc_runtime_knl_Thread_Object *obj, int ec);

/* create */
xdc__CODESECT(xdc_runtime_knl_Thread_create, "xdc_runtime_knl_Thread_create")
__extern xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_create( xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(xdc_runtime_knl_Thread_construct, "xdc_runtime_knl_Thread_construct")
__extern void xdc_runtime_knl_Thread_construct(xdc_runtime_knl_Thread_Struct *obj, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Thread_join__E( xdc_runtime_knl_Thread_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_runtime_knl_Thread_Priority xdc_runtime_knl_Thread_getPriority__E( xdc_runtime_knl_Thread_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Thread_setPriority__E( xdc_runtime_knl_Thread_Handle instp, xdc_runtime_knl_Thread_Priority newPri, xdc_runtime_Error_Block *eb);
...
__extern xdc_Int xdc_runtime_knl_Thread_getOsPriority__E( xdc_runtime_knl_Thread_Handle instp, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_Thread_setOsPriority__E( xdc_runtime_knl_Thread_Handle instp, xdc_Int newPri, xdc_runtime_Error_Block *eb);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_getOsHandle__E( xdc_runtime_knl_Thread_Handle instp);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_getTls__E( xdc_runtime_knl_Thread_Handle instp);
...
__extern xdc_Void xdc_runtime_knl_Thread_setTls__E( xdc_runtime_knl_Thread_Handle instp, xdc_Ptr tls);
...
__extern xdc_Bool xdc_runtime_knl_Thread_stat__E( xdc_runtime_knl_Thread_Handle instp, xdc_runtime_knl_Thread_Stat *buf, xdc_runtime_Error_Block *eb);
...
static inline xdc_Bool xdc_runtime_knl_Thread_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_knl_Thread_Module__diagsMask__C != (CT__xdc_runtime_knl_Thread_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_Thread_Module_getMask(void)
{
    return (xdc_runtime_knl_Thread_Module__diagsMask__C != (CT__xdc_runtime_knl_Thread_Module__diagsMask)NULL) ? *xdc_runtime_knl_Thread_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_Thread_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_Thread_Module__diagsMask__C != (CT__xdc_runtime_knl_Thread_Module__diagsMask)NULL) {
        *xdc_runtime_knl_Thread_Module__diagsMask__C = mask;
    }
}
...
{
    if (prms != NULL) {
        xdc_runtime_knl_Thread_Params__init__S(prms, NULL, sizeof(xdc_runtime_knl_Thread_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_Object_get(xdc_runtime_knl_Thread_Object *oarr, int i);
static inline xdc_runtime_knl_Thread_Handle xdc_runtime_knl_Thread_Object_get(xdc_runtime_knl_Thread_Object *oarr, int i) 
{
