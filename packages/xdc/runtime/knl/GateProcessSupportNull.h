...
__extern xdc_IArg xdc_runtime_knl_GateProcessSupportNull_enter__E( xdc_runtime_knl_GateProcessSupportNull_Handle instp);
...
__extern xdc_Void xdc_runtime_knl_GateProcessSupportNull_leave__E( xdc_runtime_knl_GateProcessSupportNull_Handle instp, xdc_IArg key);
...
__extern xdc_Int xdc_runtime_knl_GateProcessSupportNull_getReferenceCount__E( xdc_runtime_knl_GateProcessSupportNull_Handle instp, xdc_runtime_Error_Block *err);
...
/* Object_get */
static inline xdc_runtime_knl_GateProcessSupportNull_Handle xdc_runtime_knl_GateProcessSupportNull_Object_get(xdc_runtime_knl_GateProcessSupportNull_Object *oarr, int i);
static inline xdc_runtime_knl_GateProcessSupportNull_Handle xdc_runtime_knl_GateProcessSupportNull_Object_get(xdc_runtime_knl_GateProcessSupportNull_Object *oarr, int i) 
{
