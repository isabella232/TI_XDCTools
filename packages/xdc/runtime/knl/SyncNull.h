...
#define xdc_runtime_knl_SyncNull___VERS 200
...
#ifdef xdc_runtime_knl_SyncNull_Module__diagsEnabled__CR
#define xdc_runtime_knl_SyncNull_Module__diagsEnabled__C (*((CT__xdc_runtime_knl_SyncNull_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__diagsEnabled (xdc_runtime_knl_SyncNull_Module__diagsEnabled__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__diagsIncluded__CR
#define xdc_runtime_knl_SyncNull_Module__diagsIncluded__C (*((CT__xdc_runtime_knl_SyncNull_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__diagsIncluded (xdc_runtime_knl_SyncNull_Module__diagsIncluded__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__diagsMask__CR
#define xdc_runtime_knl_SyncNull_Module__diagsMask__C (*((CT__xdc_runtime_knl_SyncNull_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__diagsMask (xdc_runtime_knl_SyncNull_Module__diagsMask__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__gateObj__CR
#define xdc_runtime_knl_SyncNull_Module__gateObj__C (*((CT__xdc_runtime_knl_SyncNull_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__gateObj__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__gateObj (xdc_runtime_knl_SyncNull_Module__gateObj__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__gatePrms__CR
#define xdc_runtime_knl_SyncNull_Module__gatePrms__C (*((CT__xdc_runtime_knl_SyncNull_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__gatePrms (xdc_runtime_knl_SyncNull_Module__gatePrms__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__id__CR
#define xdc_runtime_knl_SyncNull_Module__id__C (*((CT__xdc_runtime_knl_SyncNull_Module__id*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__id__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__id (xdc_runtime_knl_SyncNull_Module__id__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerDefined__CR
#define xdc_runtime_knl_SyncNull_Module__loggerDefined__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerDefined (xdc_runtime_knl_SyncNull_Module__loggerDefined__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerObj__CR
#define xdc_runtime_knl_SyncNull_Module__loggerObj__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerObj (xdc_runtime_knl_SyncNull_Module__loggerObj__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerFxn0__CR
#define xdc_runtime_knl_SyncNull_Module__loggerFxn0__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerFxn0 (xdc_runtime_knl_SyncNull_Module__loggerFxn0__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerFxn1__CR
#define xdc_runtime_knl_SyncNull_Module__loggerFxn1__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerFxn1 (xdc_runtime_knl_SyncNull_Module__loggerFxn1__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerFxn2__CR
#define xdc_runtime_knl_SyncNull_Module__loggerFxn2__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerFxn2 (xdc_runtime_knl_SyncNull_Module__loggerFxn2__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerFxn4__CR
#define xdc_runtime_knl_SyncNull_Module__loggerFxn4__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerFxn4 (xdc_runtime_knl_SyncNull_Module__loggerFxn4__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Module__loggerFxn8__CR
#define xdc_runtime_knl_SyncNull_Module__loggerFxn8__C (*((CT__xdc_runtime_knl_SyncNull_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Module__loggerFxn8 (xdc_runtime_knl_SyncNull_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Object__count__CR
#define xdc_runtime_knl_SyncNull_Object__count__C (*((CT__xdc_runtime_knl_SyncNull_Object__count*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Object__count__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Object__count (xdc_runtime_knl_SyncNull_Object__count__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Object__heap__CR
#define xdc_runtime_knl_SyncNull_Object__heap__C (*((CT__xdc_runtime_knl_SyncNull_Object__heap*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Object__heap__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Object__heap (xdc_runtime_knl_SyncNull_Object__heap__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Object__sizeof__CR
#define xdc_runtime_knl_SyncNull_Object__sizeof__C (*((CT__xdc_runtime_knl_SyncNull_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Object__sizeof__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Object__sizeof (xdc_runtime_knl_SyncNull_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_knl_SyncNull_Object__table__CR
#define xdc_runtime_knl_SyncNull_Object__table__C (*((CT__xdc_runtime_knl_SyncNull_Object__table*)(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Object__table__C_offset)))
#else
#define xdc_runtime_knl_SyncNull_Object__table (xdc_runtime_knl_SyncNull_Object__table__C)
#endif
...
struct xdc_runtime_knl_SyncNull_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_SyncNull_Handle inst, xdc_Int qual);
    xdc_Void (*signal)(xdc_runtime_knl_SyncNull_Handle inst);
    xdc_Int (*wait)(xdc_runtime_knl_SyncNull_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef xdc_runtime_knl_SyncNull_Module__FXNS__CR

/* Module__FXNS__C */
__extern const xdc_runtime_knl_SyncNull_Fxns__ xdc_runtime_knl_SyncNull_Module__FXNS__C;
#else
#define xdc_runtime_knl_SyncNull_Module__FXNS__C (*(xdcRomConstPtr + xdc_runtime_knl_SyncNull_Module__FXNS__C_offset))
#endif
...
__extern xdc_Void xdc_runtime_knl_SyncNull_Instance_init__E(xdc_runtime_knl_SyncNull_Object *obj, const xdc_runtime_knl_SyncNull_Params *prms);

/* create */
xdc__CODESECT(xdc_runtime_knl_SyncNull_create, "xdc_runtime_knl_SyncNull_create")
__extern xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_create( const xdc_runtime_knl_SyncNull_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(xdc_runtime_knl_SyncNull_construct, "xdc_runtime_knl_SyncNull_construct")
__extern void xdc_runtime_knl_SyncNull_construct(xdc_runtime_knl_SyncNull_Struct *obj, const xdc_runtime_knl_SyncNull_Params *prms);
...
__extern xdc_Ptr xdc_runtime_knl_SyncNull_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);
...
__extern xdc_Bool xdc_runtime_knl_SyncNull_query__E( xdc_runtime_knl_SyncNull_Handle instp, xdc_Int qual);
...
__extern xdc_Void xdc_runtime_knl_SyncNull_signal__E( xdc_runtime_knl_SyncNull_Handle instp);
...
__extern xdc_Int xdc_runtime_knl_SyncNull_wait__E( xdc_runtime_knl_SyncNull_Handle instp, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
...
static inline xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&xdc_runtime_knl_SyncNull_Module__FXNS__C) ? (xdc_runtime_knl_SyncNull_Handle)i : (xdc_runtime_knl_SyncNull_Handle)NULL;
}
...
static inline xdc_Bool xdc_runtime_knl_SyncNull_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_knl_SyncNull_Module__diagsMask__C != (CT__xdc_runtime_knl_SyncNull_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_SyncNull_Module_getMask(void)
{
    return (xdc_runtime_knl_SyncNull_Module__diagsMask__C != (CT__xdc_runtime_knl_SyncNull_Module__diagsMask)NULL) ? *xdc_runtime_knl_SyncNull_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_SyncNull_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_SyncNull_Module__diagsMask__C != (CT__xdc_runtime_knl_SyncNull_Module__diagsMask)NULL) {
        *xdc_runtime_knl_SyncNull_Module__diagsMask__C = mask;
    }
}
...
{
    if (prms != NULL) {
        xdc_runtime_knl_SyncNull_Params__init__S(prms, NULL, sizeof(xdc_runtime_knl_SyncNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_Object_get(xdc_runtime_knl_SyncNull_Object *oarr, int i);
static inline xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_Object_get(xdc_runtime_knl_SyncNull_Object *oarr, int i) 
{
