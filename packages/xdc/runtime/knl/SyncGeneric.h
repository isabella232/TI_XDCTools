...
__extern xdc_Bool xdc_runtime_knl_SyncGeneric_query__E( xdc_runtime_knl_SyncGeneric_Handle instp, xdc_Int qual);
...
__extern xdc_Void xdc_runtime_knl_SyncGeneric_signal__E( xdc_runtime_knl_SyncGeneric_Handle instp);
...
__extern xdc_Int xdc_runtime_knl_SyncGeneric_wait__E( xdc_runtime_knl_SyncGeneric_Handle instp, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
...
/* Object_get */
static inline xdc_runtime_knl_SyncGeneric_Handle xdc_runtime_knl_SyncGeneric_Object_get(xdc_runtime_knl_SyncGeneric_Object *oarr, int i);
static inline xdc_runtime_knl_SyncGeneric_Handle xdc_runtime_knl_SyncGeneric_Object_get(xdc_runtime_knl_SyncGeneric_Object *oarr, int i) 
{
