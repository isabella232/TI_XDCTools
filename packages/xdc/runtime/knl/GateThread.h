...
__extern xdc_IArg xdc_runtime_knl_GateThread_enter__E( xdc_runtime_knl_GateThread_Handle instp);
...
__extern xdc_Void xdc_runtime_knl_GateThread_leave__E( xdc_runtime_knl_GateThread_Handle instp, xdc_IArg key);
...
/* Object_get */
static inline xdc_runtime_knl_GateThread_Handle xdc_runtime_knl_GateThread_Object_get(xdc_runtime_knl_GateThread_Object *oarr, int i);
static inline xdc_runtime_knl_GateThread_Handle xdc_runtime_knl_GateThread_Object_get(xdc_runtime_knl_GateThread_Object *oarr, int i) 
{
