...
__extern xdc_runtime_knl_ISemaphore_Handle xdc_runtime_knl_ISemaphore_create(xdc_runtime_knl_ISemaphore_Module mod, const xdc_runtime_knl_ISemaphore_Params *prms, xdc_runtime_Error_Block *eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISemaphore_delete, "xdc_runtime_knl_ISemaphore_delete")
__extern xdc_Void xdc_runtime_knl_ISemaphore_delete(xdc_runtime_knl_ISemaphore_Handle *inst);
...
/* pend */
static inline xdc_Int xdc_runtime_knl_ISemaphore_pend(xdc_runtime_knl_ISemaphore_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block *eb);
static inline xdc_Int xdc_runtime_knl_ISemaphore_pend( xdc_runtime_knl_ISemaphore_Handle inst, xdc_UInt timeout, xdc_runtime_Error_Block *eb )
{
...
/* post */
static inline xdc_Bool xdc_runtime_knl_ISemaphore_post(xdc_runtime_knl_ISemaphore_Handle inst, xdc_runtime_Error_Block *eb);
static inline xdc_Bool xdc_runtime_knl_ISemaphore_post( xdc_runtime_knl_ISemaphore_Handle inst, xdc_runtime_Error_Block *eb )
{
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemaphore_pend_FxnT)(xdc_Void *inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
static inline xdc_runtime_knl_ISemaphore_pend_FxnT xdc_runtime_knl_ISemaphore_pend_fxnP(xdc_runtime_knl_ISemaphore_Handle inst);
static inline xdc_runtime_knl_ISemaphore_pend_FxnT xdc_runtime_knl_ISemaphore_pend_fxnP(xdc_runtime_knl_ISemaphore_Handle inst)
{
    return (xdc_runtime_knl_ISemaphore_pend_FxnT)inst->__fxns->pend;
}

/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemaphore_post_FxnT)(xdc_Void *inst, xdc_runtime_Error_Block* eb);
static inline xdc_runtime_knl_ISemaphore_post_FxnT xdc_runtime_knl_ISemaphore_post_fxnP(xdc_runtime_knl_ISemaphore_Handle inst);
static inline xdc_runtime_knl_ISemaphore_post_FxnT xdc_runtime_knl_ISemaphore_post_fxnP(xdc_runtime_knl_ISemaphore_Handle inst)
{
    return (xdc_runtime_knl_ISemaphore_post_FxnT)inst->__fxns->post;
}
