...
/* SFxn */
typedef xdc_Int (*xdc_runtime_Startup_SFxn)(xdc_Int arg1);
...
typedef struct { int length; xdc_runtime_Startup_InitFxn const *elem; } CARRAY1_xdc_runtime_Startup_firstFxns;
typedef CARRAY1_xdc_runtime_Startup_firstFxns __TA_xdc_runtime_Startup_firstFxns;
typedef CARRAY1_xdc_runtime_Startup_firstFxns CT__xdc_runtime_Startup_firstFxns;
...
typedef struct { int length; xdc_runtime_Startup_InitFxn *elem; } ARRAY1_xdc_runtime_Startup_lastFxns;
typedef struct { int length; xdc_runtime_Startup_InitFxn const *elem; } CARRAY1_xdc_runtime_Startup_lastFxns;
typedef CARRAY1_xdc_runtime_Startup_lastFxns __TA_xdc_runtime_Startup_lastFxns;
typedef CARRAY1_xdc_runtime_Startup_lastFxns CT__xdc_runtime_Startup_lastFxns;
...
/* startModsFxn */
typedef xdc_Void (*CT__xdc_runtime_Startup_startModsFxn)(xdc_Int arg1[], xdc_Int arg2);
...
typedef xdc_runtime_Startup_SFxn *ARRAY1_xdc_runtime_Startup_sfxnTab;
typedef const xdc_runtime_Startup_SFxn *CARRAY1_xdc_runtime_Startup_sfxnTab;
typedef CARRAY1_xdc_runtime_Startup_sfxnTab __TA_xdc_runtime_Startup_sfxnTab;
typedef CARRAY1_xdc_runtime_Startup_sfxnTab CT__xdc_runtime_Startup_sfxnTab;
...
typedef xdc_Bool *ARRAY1_xdc_runtime_Startup_sfxnRts;
typedef const xdc_Bool *CARRAY1_xdc_runtime_Startup_sfxnRts;
typedef CARRAY1_xdc_runtime_Startup_sfxnRts __TA_xdc_runtime_Startup_sfxnRts;
typedef CARRAY1_xdc_runtime_Startup_sfxnRts CT__xdc_runtime_Startup_sfxnRts;
...
static inline xdc_Bool xdc_runtime_Startup_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_Startup_Module__diagsMask__C != (CT__xdc_runtime_Startup_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_Startup_Module_getMask(void)
{
    return (xdc_runtime_Startup_Module__diagsMask__C != (CT__xdc_runtime_Startup_Module__diagsMask)NULL) ? *xdc_runtime_Startup_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_Startup_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_Startup_Module__diagsMask__C != (CT__xdc_runtime_Startup_Module__diagsMask)NULL) {
