...
/* RopeVisitor */
typedef xdc_Bool (*xdc_runtime_Text_RopeVisitor)(xdc_Ptr arg1, xdc_CString arg2);
...
typedef xdc_Char *ARRAY1_xdc_runtime_Text_charTab;
typedef const xdc_Char *CARRAY1_xdc_runtime_Text_charTab;
typedef CARRAY1_xdc_runtime_Text_charTab __TA_xdc_runtime_Text_charTab;
typedef CARRAY1_xdc_runtime_Text_charTab CT__xdc_runtime_Text_charTab;
...
typedef xdc_runtime_Text_Node *ARRAY1_xdc_runtime_Text_nodeTab;
typedef const xdc_runtime_Text_Node *CARRAY1_xdc_runtime_Text_nodeTab;
typedef CARRAY1_xdc_runtime_Text_nodeTab __TA_xdc_runtime_Text_nodeTab;
typedef CARRAY1_xdc_runtime_Text_nodeTab CT__xdc_runtime_Text_nodeTab;
...
static inline xdc_Bool xdc_runtime_Text_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_Text_Module__diagsMask__C != (CT__xdc_runtime_Text_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_Text_Module_getMask(void)
{
    return (xdc_runtime_Text_Module__diagsMask__C != (CT__xdc_runtime_Text_Module__diagsMask)NULL) ? *xdc_runtime_Text_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_Text_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_Text_Module__diagsMask__C != (CT__xdc_runtime_Text_Module__diagsMask)NULL) {
