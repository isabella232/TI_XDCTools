...
#define xdc_runtime_GateNull___VERS 200
...
#define xdc_runtime_GateNull_Module__diagsEnabled__C (*((CT__xdc_runtime_GateNull_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_GateNull_Module__diagsEnabled (xdc_runtime_GateNull_Module__diagsEnabled__C)
#endif
...
#define xdc_runtime_GateNull_Module__diagsIncluded__C (*((CT__xdc_runtime_GateNull_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_GateNull_Module__diagsIncluded (xdc_runtime_GateNull_Module__diagsIncluded__C)
#endif
...
#define xdc_runtime_GateNull_Module__diagsMask__C (*((CT__xdc_runtime_GateNull_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_GateNull_Module__diagsMask (xdc_runtime_GateNull_Module__diagsMask__C)
#endif
...
#define xdc_runtime_GateNull_Module__gateObj__C (*((CT__xdc_runtime_GateNull_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__gateObj__C_offset)))
#else
#define xdc_runtime_GateNull_Module__gateObj (xdc_runtime_GateNull_Module__gateObj__C)
#endif
...
#define xdc_runtime_GateNull_Module__gatePrms__C (*((CT__xdc_runtime_GateNull_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_GateNull_Module__gatePrms (xdc_runtime_GateNull_Module__gatePrms__C)
#endif
...
#define xdc_runtime_GateNull_Module__id__C (*((CT__xdc_runtime_GateNull_Module__id*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__id__C_offset)))
#else
#define xdc_runtime_GateNull_Module__id (xdc_runtime_GateNull_Module__id__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerDefined__C (*((CT__xdc_runtime_GateNull_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerDefined (xdc_runtime_GateNull_Module__loggerDefined__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerObj__C (*((CT__xdc_runtime_GateNull_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerObj (xdc_runtime_GateNull_Module__loggerObj__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerFxn0__C (*((CT__xdc_runtime_GateNull_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerFxn0 (xdc_runtime_GateNull_Module__loggerFxn0__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerFxn1__C (*((CT__xdc_runtime_GateNull_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerFxn1 (xdc_runtime_GateNull_Module__loggerFxn1__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerFxn2__C (*((CT__xdc_runtime_GateNull_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerFxn2 (xdc_runtime_GateNull_Module__loggerFxn2__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerFxn4__C (*((CT__xdc_runtime_GateNull_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerFxn4 (xdc_runtime_GateNull_Module__loggerFxn4__C)
#endif
...
#define xdc_runtime_GateNull_Module__loggerFxn8__C (*((CT__xdc_runtime_GateNull_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_GateNull_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_GateNull_Module__loggerFxn8 (xdc_runtime_GateNull_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_GateNull_Object__count__CR
#define xdc_runtime_GateNull_Object__count__C (*((CT__xdc_runtime_GateNull_Object__count*)(xdcRomConstPtr + xdc_runtime_GateNull_Object__count__C_offset)))
#else
#define xdc_runtime_GateNull_Object__count (xdc_runtime_GateNull_Object__count__C)
#endif
...
#ifdef xdc_runtime_GateNull_Object__heap__CR
#define xdc_runtime_GateNull_Object__heap__C (*((CT__xdc_runtime_GateNull_Object__heap*)(xdcRomConstPtr + xdc_runtime_GateNull_Object__heap__C_offset)))
#else
#define xdc_runtime_GateNull_Object__heap (xdc_runtime_GateNull_Object__heap__C)
#endif
...
#ifdef xdc_runtime_GateNull_Object__sizeof__CR
#define xdc_runtime_GateNull_Object__sizeof__C (*((CT__xdc_runtime_GateNull_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_GateNull_Object__sizeof__C_offset)))
#else
#define xdc_runtime_GateNull_Object__sizeof (xdc_runtime_GateNull_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_GateNull_Object__table__CR
#define xdc_runtime_GateNull_Object__table__C (*((CT__xdc_runtime_GateNull_Object__table*)(xdcRomConstPtr + xdc_runtime_GateNull_Object__table__C_offset)))
#else
#define xdc_runtime_GateNull_Object__table (xdc_runtime_GateNull_Object__table__C)
#endif
...
struct xdc_runtime_GateNull_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_GateNull_Handle inst);
    xdc_Void (*leave)(xdc_runtime_GateNull_Handle inst, xdc_IArg key);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef xdc_runtime_GateNull_Module__FXNS__CR

/* Module__FXNS__C */
__extern const xdc_runtime_GateNull_Fxns__ xdc_runtime_GateNull_Module__FXNS__C;
#else
#define xdc_runtime_GateNull_Module__FXNS__C (*(xdcRomConstPtr + xdc_runtime_GateNull_Module__FXNS__C_offset))
#endif
...
/* Instance_init__E */
xdc__CODESECT(xdc_runtime_GateNull_Instance_init__E, "xdc_runtime_GateNull_Instance_init")
__extern xdc_Void xdc_runtime_GateNull_Instance_init__E(xdc_runtime_GateNull_Object *obj, const xdc_runtime_GateNull_Params *prms);

/* create */
xdc__CODESECT(xdc_runtime_GateNull_create, "xdc_runtime_GateNull_create")
__extern xdc_runtime_GateNull_Handle xdc_runtime_GateNull_create( const xdc_runtime_GateNull_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(xdc_runtime_GateNull_construct, "xdc_runtime_GateNull_construct")
__extern void xdc_runtime_GateNull_construct(xdc_runtime_GateNull_Struct *obj, const xdc_runtime_GateNull_Params *prms);

/* delete */
xdc__CODESECT(xdc_runtime_GateNull_delete, "xdc_runtime_GateNull_delete")
__extern void xdc_runtime_GateNull_delete(xdc_runtime_GateNull_Handle *instp);

/* destruct */
xdc__CODESECT(xdc_runtime_GateNull_destruct, "xdc_runtime_GateNull_destruct")
__extern void xdc_runtime_GateNull_destruct(xdc_runtime_GateNull_Struct *obj);

/* Handle__label__S */
xdc__CODESECT(xdc_runtime_GateNull_Handle__label__S, "xdc_runtime_GateNull_Handle__label__S")
__extern xdc_runtime_Types_Label *xdc_runtime_GateNull_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label *lab);

/* Module__startupDone__S */
xdc__CODESECT(xdc_runtime_GateNull_Module__startupDone__S, "xdc_runtime_GateNull_Module__startupDone__S")
__extern xdc_Bool xdc_runtime_GateNull_Module__startupDone__S( void);

/* Object__create__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__create__S, "xdc_runtime_GateNull_Object__create__S")
__extern xdc_Ptr xdc_runtime_GateNull_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__delete__S, "xdc_runtime_GateNull_Object__delete__S")
__extern xdc_Void xdc_runtime_GateNull_Object__delete__S( xdc_Ptr instp);

/* Object__get__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__get__S, "xdc_runtime_GateNull_Object__get__S")
__extern xdc_Ptr xdc_runtime_GateNull_Object__get__S( xdc_Ptr oarr, xdc_Int i);

/* Object__first__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__first__S, "xdc_runtime_GateNull_Object__first__S")
__extern xdc_Ptr xdc_runtime_GateNull_Object__first__S( void);

/* Object__next__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__next__S, "xdc_runtime_GateNull_Object__next__S")
__extern xdc_Ptr xdc_runtime_GateNull_Object__next__S( xdc_Ptr obj);

/* Params__init__S */
xdc__CODESECT(xdc_runtime_GateNull_Params__init__S, "xdc_runtime_GateNull_Params__init__S")
__extern xdc_Void xdc_runtime_GateNull_Params__init__S( xdc_Ptr dst, const xdc_Void *src, xdc_SizeT psz, xdc_SizeT isz);
...
__extern xdc_IArg xdc_runtime_GateNull_enter__E( xdc_runtime_GateNull_Handle instp);
...
__extern xdc_Void xdc_runtime_GateNull_leave__E( xdc_runtime_GateNull_Handle instp, xdc_IArg key);
...
static inline xdc_runtime_GateNull_Handle xdc_runtime_GateNull_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&xdc_runtime_GateNull_Module__FXNS__C) ? (xdc_runtime_GateNull_Handle)i : (xdc_runtime_GateNull_Handle)NULL;
}
...
static inline xdc_Bool xdc_runtime_GateNull_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_GateNull_Module__diagsMask__C != (CT__xdc_runtime_GateNull_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_GateNull_Module_getMask(void)
{
    return (xdc_runtime_GateNull_Module__diagsMask__C != (CT__xdc_runtime_GateNull_Module__diagsMask)NULL) ? *xdc_runtime_GateNull_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_GateNull_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_GateNull_Module__diagsMask__C != (CT__xdc_runtime_GateNull_Module__diagsMask)NULL) {
        *xdc_runtime_GateNull_Module__diagsMask__C = mask;
    }
}
...
{
    if (prms != NULL) {
        xdc_runtime_GateNull_Params__init__S(prms, NULL, sizeof(xdc_runtime_GateNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
{
    if (dst != NULL) {
        xdc_runtime_GateNull_Params__init__S(dst, (const void *)src, sizeof(xdc_runtime_GateNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline xdc_runtime_GateNull_Handle xdc_runtime_GateNull_Object_get(xdc_runtime_GateNull_Object *oarr, int i);
static inline xdc_runtime_GateNull_Handle xdc_runtime_GateNull_Object_get(xdc_runtime_GateNull_Object *oarr, int i) 
{
...
/* Handle_name */
static inline xdc_String xdc_runtime_GateNull_Handle_name(xdc_runtime_GateNull_Handle inst);
static inline xdc_String xdc_runtime_GateNull_Handle_name(xdc_runtime_GateNull_Handle inst)
{
