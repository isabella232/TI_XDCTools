...
#define xdc_runtime_Diags___VERS 200
...
/* ENTRY */
#define xdc_runtime_Diags_ENTRY (0x0001U)

/* EXIT */
#define xdc_runtime_Diags_EXIT (0x0002U)

/* LIFECYCLE */
#define xdc_runtime_Diags_LIFECYCLE (0x0004U)

/* INTERNAL */
#define xdc_runtime_Diags_INTERNAL (0x0008U)

/* ASSERT */
#define xdc_runtime_Diags_ASSERT (0x0010U)

/* STATUS */
#define xdc_runtime_Diags_STATUS (0x0080U)

/* LEVEL */
#define xdc_runtime_Diags_LEVEL (0x0060U)

/* USER1 */
#define xdc_runtime_Diags_USER1 (0x0100U)

/* USER2 */
#define xdc_runtime_Diags_USER2 (0x0200U)

/* USER3 */
#define xdc_runtime_Diags_USER3 (0x0400U)

/* USER4 */
#define xdc_runtime_Diags_USER4 (0x0800U)

/* USER5 */
#define xdc_runtime_Diags_USER5 (0x1000U)

/* USER6 */
#define xdc_runtime_Diags_USER6 (0x2000U)

/* USER7 */
#define xdc_runtime_Diags_USER7 (0x4000U)

/* INFO */
#define xdc_runtime_Diags_INFO (0x4000U)

/* USER8 */
#define xdc_runtime_Diags_USER8 (0x8000U)

/* ANALYSIS */
#define xdc_runtime_Diags_ANALYSIS (0x8000U)

/* ALL */
#define xdc_runtime_Diags_ALL (0xFF9FU)

/* ALL_LOGGING */
#define xdc_runtime_Diags_ALL_LOGGING (0xFF9FU & (~0x0010U) & (~0x0008U))
...
#ifdef xdc_runtime_Diags_Module__diagsEnabled__CR
#define xdc_runtime_Diags_Module__diagsEnabled__C (*((CT__xdc_runtime_Diags_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_Diags_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_Diags_Module__diagsEnabled (xdc_runtime_Diags_Module__diagsEnabled__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__diagsIncluded__CR
#define xdc_runtime_Diags_Module__diagsIncluded__C (*((CT__xdc_runtime_Diags_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_Diags_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_Diags_Module__diagsIncluded (xdc_runtime_Diags_Module__diagsIncluded__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__diagsMask__CR
#define xdc_runtime_Diags_Module__diagsMask__C (*((CT__xdc_runtime_Diags_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_Diags_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_Diags_Module__diagsMask (xdc_runtime_Diags_Module__diagsMask__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__gateObj__CR
#define xdc_runtime_Diags_Module__gateObj__C (*((CT__xdc_runtime_Diags_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_Diags_Module__gateObj__C_offset)))
#else
#define xdc_runtime_Diags_Module__gateObj (xdc_runtime_Diags_Module__gateObj__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__gatePrms__CR
#define xdc_runtime_Diags_Module__gatePrms__C (*((CT__xdc_runtime_Diags_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_Diags_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_Diags_Module__gatePrms (xdc_runtime_Diags_Module__gatePrms__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__id__CR
#define xdc_runtime_Diags_Module__id__C (*((CT__xdc_runtime_Diags_Module__id*)(xdcRomConstPtr + xdc_runtime_Diags_Module__id__C_offset)))
#else
#define xdc_runtime_Diags_Module__id (xdc_runtime_Diags_Module__id__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerDefined__CR
#define xdc_runtime_Diags_Module__loggerDefined__C (*((CT__xdc_runtime_Diags_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerDefined (xdc_runtime_Diags_Module__loggerDefined__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerObj__CR
#define xdc_runtime_Diags_Module__loggerObj__C (*((CT__xdc_runtime_Diags_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerObj (xdc_runtime_Diags_Module__loggerObj__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerFxn0__CR
#define xdc_runtime_Diags_Module__loggerFxn0__C (*((CT__xdc_runtime_Diags_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerFxn0 (xdc_runtime_Diags_Module__loggerFxn0__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerFxn1__CR
#define xdc_runtime_Diags_Module__loggerFxn1__C (*((CT__xdc_runtime_Diags_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerFxn1 (xdc_runtime_Diags_Module__loggerFxn1__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerFxn2__CR
#define xdc_runtime_Diags_Module__loggerFxn2__C (*((CT__xdc_runtime_Diags_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerFxn2 (xdc_runtime_Diags_Module__loggerFxn2__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerFxn4__CR
#define xdc_runtime_Diags_Module__loggerFxn4__C (*((CT__xdc_runtime_Diags_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerFxn4 (xdc_runtime_Diags_Module__loggerFxn4__C)
#endif
...
#ifdef xdc_runtime_Diags_Module__loggerFxn8__CR
#define xdc_runtime_Diags_Module__loggerFxn8__C (*((CT__xdc_runtime_Diags_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_Diags_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_Diags_Module__loggerFxn8 (xdc_runtime_Diags_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_Diags_Object__count__CR
#define xdc_runtime_Diags_Object__count__C (*((CT__xdc_runtime_Diags_Object__count*)(xdcRomConstPtr + xdc_runtime_Diags_Object__count__C_offset)))
#else
#define xdc_runtime_Diags_Object__count (xdc_runtime_Diags_Object__count__C)
#endif
...
#ifdef xdc_runtime_Diags_Object__heap__CR
#define xdc_runtime_Diags_Object__heap__C (*((CT__xdc_runtime_Diags_Object__heap*)(xdcRomConstPtr + xdc_runtime_Diags_Object__heap__C_offset)))
#else
#define xdc_runtime_Diags_Object__heap (xdc_runtime_Diags_Object__heap__C)
#endif
...
#ifdef xdc_runtime_Diags_Object__sizeof__CR
#define xdc_runtime_Diags_Object__sizeof__C (*((CT__xdc_runtime_Diags_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_Diags_Object__sizeof__C_offset)))
#else
#define xdc_runtime_Diags_Object__sizeof (xdc_runtime_Diags_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_Diags_Object__table__CR
#define xdc_runtime_Diags_Object__table__C (*((CT__xdc_runtime_Diags_Object__table*)(xdcRomConstPtr + xdc_runtime_Diags_Object__table__C_offset)))
#else
#define xdc_runtime_Diags_Object__table (xdc_runtime_Diags_Object__table__C)
#endif
...
#ifdef xdc_runtime_Diags_setMaskEnabled__CR
#define xdc_runtime_Diags_setMaskEnabled (*((CT__xdc_runtime_Diags_setMaskEnabled*)(xdcRomConstPtr + xdc_runtime_Diags_setMaskEnabled__C_offset)))
#else
...
#ifdef xdc_runtime_Diags_dictBase__CR
#define xdc_runtime_Diags_dictBase (*((CT__xdc_runtime_Diags_dictBase*)(xdcRomConstPtr + xdc_runtime_Diags_dictBase__C_offset)))
#else
...
static inline xdc_Bool xdc_runtime_Diags_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_Diags_Module__diagsMask__C != (CT__xdc_runtime_Diags_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_Diags_Module_getMask(void)
{
    return (xdc_runtime_Diags_Module__diagsMask__C != (CT__xdc_runtime_Diags_Module__diagsMask)NULL) ? *xdc_runtime_Diags_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_Diags_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_Diags_Module__diagsMask__C != (CT__xdc_runtime_Diags_Module__diagsMask)NULL) {
