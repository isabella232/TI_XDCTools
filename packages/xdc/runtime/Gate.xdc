...
module Gate {
     ...
     *  The parameters passed to the `IGateProvider` are specified at the
     *  configuration time via the
     * `{@link Types#Common$ Types.Common$.gateParams}` configuration parameter.
     *
     ...
     *      instance to be created. It is a caller's responsibility to ensure
     *      that the type of `fldName` is a handle to an `IGateProvider`
     *      instance.
     */
    /* REQ_TAG(SYSBIOS-930) */
