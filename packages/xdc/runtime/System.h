...
/* AtexitHandler */
typedef xdc_Void (*xdc_runtime_System_AtexitHandler)(xdc_Int arg1);
...
/* ExitFxn */
typedef xdc_Void (*xdc_runtime_System_ExitFxn)(xdc_Int arg1);
...
/* ExtendFxn */
typedef xdc_Int (*xdc_runtime_System_ExtendFxn)(xdc_Char** arg1, xdc_CString* arg2, xdc_VaList* arg3, xdc_runtime_System_ParseData* arg4);

/* Module_State */
typedef xdc_runtime_System_AtexitHandler __T1_xdc_runtime_System_Module_State__atexitHandlers;
typedef xdc_runtime_System_AtexitHandler *ARRAY1_xdc_runtime_System_Module_State__atexitHandlers;
typedef const xdc_runtime_System_AtexitHandler *CARRAY1_xdc_runtime_System_Module_State__atexitHandlers;
typedef ARRAY1_xdc_runtime_System_Module_State__atexitHandlers __TA_xdc_runtime_System_Module_State__atexitHandlers;
...
static inline xdc_Bool xdc_runtime_System_Module_hasMask(void)
{
    return (xdc_Bool)(xdc_runtime_System_Module__diagsMask__C != (CT__xdc_runtime_System_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 xdc_runtime_System_Module_getMask(void)
{
    return (xdc_runtime_System_Module__diagsMask__C != (CT__xdc_runtime_System_Module__diagsMask)NULL) ? *xdc_runtime_System_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_System_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_System_Module__diagsMask__C != (CT__xdc_runtime_System_Module__diagsMask)NULL) {
