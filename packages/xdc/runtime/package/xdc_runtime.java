...
public class xdc_runtime
{
    ...
    void Registry$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Registry.findByNamePattern", new Extern("xdc_runtime_Registry_findByNamePattern__E", "xdc_runtime_Types_RegDesc*(*)(xdc_CString,xdc_UShort,xdc_runtime_Types_RegDesc*)", true, false));
        ...
        om.bind("xdc.runtime.Registry.matchPattern", new Extern("xdc_runtime_Registry_matchPattern__I", "xdc_Bool(*)(xdc_CString,xdc_UShort,xdc_CString)", true, false));
    }
    ...
    void Text$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Text.matchRope", new Extern("xdc_runtime_Text_matchRope__E", "xdc_Int(*)(xdc_Bits16,xdc_CString,xdc_UShort*)", true, false));
    ...
    void LoggerBuf$$SIZES()
    {
        ...
        sizes.add(Global.newArray("serial", "UInt32"));
        sizes.add(Global.newArray("numEntries", "UInt16"));
    ...
    void Text$$SIZES()
    {
        ...
        sizes.add(Global.newArray("len", "UShort"));
        sizes.add(Global.newArray("res", "TInt"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
    ...
    void LoggerBuf$$TYPES()
    {
        ...
        po.init("xdc.runtime.LoggerBuf.Instance", om.findStrict("xdc.runtime.IFilterLogger.Instance", "xdc.runtime"));
                ...
                po.addFld("NEXT", Proto.Elm.newCNum("(xdc_Int8)"), 1L, "rh");
        if (isCFG) {
            po.addFld("numEntries", Proto.Elm.newCNum("(xdc_UInt)"), 64L, "w");
        ...
        po.init("xdc.runtime.LoggerBuf.BasicView", null);
                ...
                po.addFld("numEntries", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
        ...
        po.init("xdc.runtime.LoggerBuf.Instance_State", null);
                ...
                po.addFld("serial", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("numEntries", Proto.Elm.newCNum("(xdc_UInt16)"), $$UNDEF, "w");
    ...
    void Text$$TYPES()
    {
        ...
        po.init("xdc.runtime.Text.MatchVisState", null);
                ...
                po.addFld("lenp", new Proto.Adr("xdc_UShort*", "Pn"), $$UNDEF, "w");
