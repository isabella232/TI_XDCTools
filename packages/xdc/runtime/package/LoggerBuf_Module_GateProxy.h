...
struct xdc_runtime_LoggerBuf_Module_GateProxy_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_LoggerBuf_Module_GateProxy_Handle inst);
    xdc_Void (*leave)(xdc_runtime_LoggerBuf_Module_GateProxy_Handle inst, xdc_IArg key);
...
__extern xdc_runtime_LoggerBuf_Module_GateProxy_Handle xdc_runtime_LoggerBuf_Module_GateProxy_create( const xdc_runtime_LoggerBuf_Module_GateProxy_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_IArg xdc_runtime_LoggerBuf_Module_GateProxy_enter__E( xdc_runtime_LoggerBuf_Module_GateProxy_Handle instp);
...
__extern xdc_Void xdc_runtime_LoggerBuf_Module_GateProxy_leave__E( xdc_runtime_LoggerBuf_Module_GateProxy_Handle instp, xdc_IArg key);
...
static inline xdc_runtime_LoggerBuf_Module_GateProxy_Handle xdc_runtime_LoggerBuf_Module_GateProxy_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    if (xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__abstract__S() != 0U) {
        return (xdc_runtime_LoggerBuf_Module_GateProxy_Handle)i;
    }
    return ((const void*)i2->__fxns == (const void*)xdc_runtime_LoggerBuf_Module_GateProxy_Proxy__delegate__S()) ? (xdc_runtime_LoggerBuf_Module_GateProxy_Handle)i : (xdc_runtime_LoggerBuf_Module_GateProxy_Handle)NULL;
}
...
{
    if (prms != NULL) {
        xdc_runtime_LoggerBuf_Module_GateProxy_Params__init__S(prms, NULL, sizeof(xdc_runtime_LoggerBuf_Module_GateProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
