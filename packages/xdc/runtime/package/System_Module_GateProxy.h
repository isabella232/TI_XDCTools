...
#define xdc_runtime_System_Module_GateProxy___VERS 200
...
#define xdc_runtime_System_Module_GateProxy_Module__diagsEnabled__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__diagsEnabled*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__diagsEnabled__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__diagsEnabled (xdc_runtime_System_Module_GateProxy_Module__diagsEnabled__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__diagsIncluded__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__diagsIncluded*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__diagsIncluded__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__diagsIncluded (xdc_runtime_System_Module_GateProxy_Module__diagsIncluded__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__diagsMask__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__diagsMask*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__diagsMask__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__diagsMask (xdc_runtime_System_Module_GateProxy_Module__diagsMask__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__gateObj__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__gateObj*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__gateObj__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__gateObj (xdc_runtime_System_Module_GateProxy_Module__gateObj__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__gatePrms__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__gatePrms*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__gatePrms__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__gatePrms (xdc_runtime_System_Module_GateProxy_Module__gatePrms__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__id__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__id*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__id__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__id (xdc_runtime_System_Module_GateProxy_Module__id__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerDefined__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerDefined*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerDefined__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerDefined (xdc_runtime_System_Module_GateProxy_Module__loggerDefined__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerObj__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerObj*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerObj__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerObj (xdc_runtime_System_Module_GateProxy_Module__loggerObj__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn0__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerFxn0*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerFxn0__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn0 (xdc_runtime_System_Module_GateProxy_Module__loggerFxn0__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn1__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerFxn1*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerFxn1__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn1 (xdc_runtime_System_Module_GateProxy_Module__loggerFxn1__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn2__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerFxn2*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerFxn2__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn2 (xdc_runtime_System_Module_GateProxy_Module__loggerFxn2__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn4__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerFxn4*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerFxn4__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn4 (xdc_runtime_System_Module_GateProxy_Module__loggerFxn4__C)
#endif
...
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn8__C (*((CT__xdc_runtime_System_Module_GateProxy_Module__loggerFxn8*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__loggerFxn8__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Module__loggerFxn8 (xdc_runtime_System_Module_GateProxy_Module__loggerFxn8__C)
#endif
...
#ifdef xdc_runtime_System_Module_GateProxy_Object__count__CR
#define xdc_runtime_System_Module_GateProxy_Object__count__C (*((CT__xdc_runtime_System_Module_GateProxy_Object__count*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Object__count__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Object__count (xdc_runtime_System_Module_GateProxy_Object__count__C)
#endif
...
#ifdef xdc_runtime_System_Module_GateProxy_Object__heap__CR
#define xdc_runtime_System_Module_GateProxy_Object__heap__C (*((CT__xdc_runtime_System_Module_GateProxy_Object__heap*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Object__heap__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Object__heap (xdc_runtime_System_Module_GateProxy_Object__heap__C)
#endif
...
#ifdef xdc_runtime_System_Module_GateProxy_Object__sizeof__CR
#define xdc_runtime_System_Module_GateProxy_Object__sizeof__C (*((CT__xdc_runtime_System_Module_GateProxy_Object__sizeof*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Object__sizeof__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Object__sizeof (xdc_runtime_System_Module_GateProxy_Object__sizeof__C)
#endif
...
#ifdef xdc_runtime_System_Module_GateProxy_Object__table__CR
#define xdc_runtime_System_Module_GateProxy_Object__table__C (*((CT__xdc_runtime_System_Module_GateProxy_Object__table*)(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Object__table__C_offset)))
#else
#define xdc_runtime_System_Module_GateProxy_Object__table (xdc_runtime_System_Module_GateProxy_Object__table__C)
#endif
...
struct xdc_runtime_System_Module_GateProxy_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_System_Module_GateProxy_Handle inst);
    xdc_Void (*leave)(xdc_runtime_System_Module_GateProxy_Handle inst, xdc_IArg key);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef xdc_runtime_System_Module_GateProxy_Module__FXNS__CR

/* Module__FXNS__C */
__extern const xdc_runtime_System_Module_GateProxy_Fxns__ xdc_runtime_System_Module_GateProxy_Module__FXNS__C;
#else
#define xdc_runtime_System_Module_GateProxy_Module__FXNS__C (*(xdcRomConstPtr + xdc_runtime_System_Module_GateProxy_Module__FXNS__C_offset))
#endif
...
__extern xdc_runtime_System_Module_GateProxy_Handle xdc_runtime_System_Module_GateProxy_create( const xdc_runtime_System_Module_GateProxy_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_CPtr xdc_runtime_System_Module_GateProxy_Proxy__delegate__S( void);
...
__extern xdc_IArg xdc_runtime_System_Module_GateProxy_enter__E( xdc_runtime_System_Module_GateProxy_Handle instp);
...
__extern xdc_Void xdc_runtime_System_Module_GateProxy_leave__E( xdc_runtime_System_Module_GateProxy_Handle instp, xdc_IArg key);
...
static inline xdc_runtime_System_Module_GateProxy_Handle xdc_runtime_System_Module_GateProxy_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    if (xdc_runtime_System_Module_GateProxy_Proxy__abstract__S() != 0U) {
        return (xdc_runtime_System_Module_GateProxy_Handle)i;
    }
    return ((const void*)i2->__fxns == (const void*)xdc_runtime_System_Module_GateProxy_Proxy__delegate__S()) ? (xdc_runtime_System_Module_GateProxy_Handle)i : (xdc_runtime_System_Module_GateProxy_Handle)NULL;
}
...
{
    if (prms != NULL) {
        xdc_runtime_System_Module_GateProxy_Params__init__S(prms, NULL, sizeof(xdc_runtime_System_Module_GateProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
