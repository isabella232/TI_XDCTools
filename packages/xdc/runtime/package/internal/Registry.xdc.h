...
/* module */
#ifdef xdc_runtime_Registry_Module__state__VR
#define Registry_module ((xdc_runtime_Registry_Module_State *)(xdcRomStatePtr + xdc_runtime_Registry_Module__state__V_offset))
#define module ((xdc_runtime_Registry_Module_State *)(xdcRomStatePtr + xdc_runtime_Registry_Module__state__V_offset))
#else
...
#define Module__MID (*((CT__xdc_runtime_Registry_Module__id *)(xdcRomConstPtr + xdc_runtime_Registry_Module__id__C_offset)))
#else
...
#define Module__DGSINCL (*((CT__xdc_runtime_Registry_Module__diagsIncluded *)(xdcRomConstPtr + xdc_runtime_Registry_Module__diagsIncluded__C_offset)))
#else
...
#define Module__DGSENAB (*((CT__xdc_runtime_Registry_Module__diagsEnabled *)(xdcRomConstPtr + xdc_runtime_Registry_Module__diagsEnabled__C_offset)))
#else
...
#define Module__DGSMASK (*((CT__xdc_runtime_Registry_Module__diagsMask *)(xdcRomConstPtr + xdc_runtime_Registry_Module__diagsMask__C_offset)))
#else
...
#define Module__LOGDEF (*((CT__xdc_runtime_Registry_Module__loggerDefined *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerDefined__C_offset)))
#else
...
#define Module__LOGOBJ xdc_runtime_Registry_Module__loggerObj__R
#define Module__LOGOBJ (*((CT__xdc_runtime_Registry_Module__loggerObj *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerObj__C_offset)))
#else
...
#define Module__LOGFXN0 (*((CT__xdc_runtime_Registry_Module__loggerFxn0 *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerFxn0__C_offset)))
#else
...
#define Module__LOGFXN1 (*((CT__xdc_runtime_Registry_Module__loggerFxn1 *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerFxn1__C_offset)))
#else
...
#define Module__LOGFXN2 (*((CT__xdc_runtime_Registry_Module__loggerFxn2 *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerFxn2__C_offset)))
#else
...
#define Module__LOGFXN4 (*((CT__xdc_runtime_Registry_Module__loggerFxn4 *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerFxn4__C_offset)))
#else
...
#define Module__LOGFXN8 (*((CT__xdc_runtime_Registry_Module__loggerFxn8 *)(xdcRomConstPtr + xdc_runtime_Registry_Module__loggerFxn8__C_offset)))
#else
...
#define Module__G_OBJ (*((CT__xdc_runtime_Registry_Module__gateObj *)(xdcRomConstPtr + xdc_runtime_Registry_Module__gateObj__C_offset)))
#else
...
#define Module__G_PRMS (*((CT__xdc_runtime_Registry_Module__gatePrms *)(xdcRomConstPtr + xdc_runtime_Registry_Module__gatePrms__C_offset)))
#else
