...
/* module */
#ifdef xdc_runtime_HeapStd_Module__state__VR
#define HeapStd_module ((xdc_runtime_HeapStd_Module_State *)(xdcRomStatePtr + xdc_runtime_HeapStd_Module__state__V_offset))
#define module ((xdc_runtime_HeapStd_Module_State *)(xdcRomStatePtr + xdc_runtime_HeapStd_Module__state__V_offset))
#else
