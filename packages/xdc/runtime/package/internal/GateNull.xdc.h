...
#define xdc_runtime_GateNull_Module_startup xdc_runtime_GateNull_Module_startup__E

/* Instance_init */
#undef xdc_runtime_GateNull_Instance_init
#define xdc_runtime_GateNull_Instance_init xdc_runtime_GateNull_Instance_init__E

/* Instance_finalize */
#undef xdc_runtime_GateNull_Instance_finalize
#define xdc_runtime_GateNull_Instance_finalize xdc_runtime_GateNull_Instance_finalize__E
