...
public class xdc_services_mapping
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("xdc.services.mapping.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("xdc.services.mapping", new Value.Obj("xdc.services.mapping", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("xdc.services.mapping.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "xdc.services.mapping"));
